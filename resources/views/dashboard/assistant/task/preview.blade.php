...
<html lang="en">
<head>
    <title>{{ $request->title }} - Assistant Manager</title>
    <meta charset="utf-8">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    <strong>Halaman <em>preview</em> yang akan dilihat oleh mahasiswa ketika akan mengumpulkan tugas.</strong>
...
<script>
    ...
    $('#form-wizard').bootstrapWizard({
        ...
        onNext: function (tab, navigation, index) {
            if (index === 1) {
                notify('Fitur ini tidak berfungsi di Halaman <em>preview<em>.', 'danger');
                return false;
            }
