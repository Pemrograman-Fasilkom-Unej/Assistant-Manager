...
@section('breadcrumb')
    <div class="col-md-12">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('assistant.task.index') }}">Daftar Tugas</a></li>
                ...
                <div class="card-body task-details">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <a class="btn btn-sm btn-info text-white" href="{{ route('assistant.task.edit', $task) }}">Edit</a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
        ...
        <div class="col-xl-8 col-lg-12">
            <div class="card support-bar overflow-hidden">
                <div class="card-header">
                    ...
                    <a href="{{ route('assistant.class.show', $task->classes) }}"><span
            ...
            $('body').on('click', '.add-score-btn', function () {
                ...
                $.get({
                    ...
                    success: (r) => {
                        ...
                        $('#score-form').attr('action', '{{ route('assistant.task.score.store', $task) }}')
                    }
                })
            });
