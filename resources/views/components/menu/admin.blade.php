<ul class="sidebar-menu">
    ...
    <li class="nav-item">
        ...
        <a href="{{ route('dashboard.admin.classroom.index') }}" class="nav-link {{ request()->is('dashboard/admin/classroom') ? 'active' : '' }}"><i class="fas fa-group fa-users"></i><span>Classroom</span></a>
