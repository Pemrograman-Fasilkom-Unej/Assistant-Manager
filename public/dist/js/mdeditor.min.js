window.CodeMirror = function () {
    ...
    function e(r, n) {
        ...
        l.wrapper.CodeMirror = this, u(this), n.autofocus && !Wi && dt(this), this.state = {
            keyMaps: [],
            overlays: [],
            modeGen: 0,
            overwrite: !1,
        ...
        var a = n.value;
        "string" == typeof a && (a = new yo(n.value, n.mode)), ot(this, cn)(this, a), Li && setTimeout(ei(ft, this, !0), 20), mt(this);
        var c;
        try {
            c = document.activeElement == l.input
        } catch (h) {
        }
        c || n.autofocus && !Wi ? setTimeout(ei(Ft, this), 20) : Dt(this), ot(this, function () {
    ...
    function r(t) {
        ...
        }), t.doc.frontier = t.doc.first, D(t, 100), t.state.modeGen++, t.curOp && at(t)
    }

    function n(e) {
        e.options.lineWrapping ? (e.display.wrapper.className += " CodeMirror-wrap", e.display.sizer.style.minWidth = "") : (e.display.wrapper.className = e.display.wrapper.className.replace(" CodeMirror-wrap", ""), h(e)), o(e), at(e), G(e), setTimeout(function () {
            d(e)
        }, 100)
    }

    function i(e) {
        var t = tt(e.display), r = e.options.lineWrapping,
            n = r && Math.max(5, e.display.scroller.clientWidth / rt(e.display) - 3);
        return function (i) {
            return Pr(e.doc, i) ? 0 : r ? (Math.ceil(i.text.length / n) || 1) * t : t
        }
    }
    ...
    function l(e) {
        var t = ho[e.options.keyMap], r = t.style;
    ...
    function s(e) {
        e.display.wrapper.className = e.display.wrapper.className.replace(/\s*cm-s-\S+/g, "") + e.options.theme.replace(/(^|\s)\s*/g, " cm-s-"), G(e)
    }
    ...
    function u(e) {
        ...
        for (var n = 0; n < r.length; ++n) {
            var i = r[n], o = t.appendChild(ni("div", null, "CodeMirror-gutter " + i));
    ...
    function c(e, t) {
        ...
        for (var r, n = t.text.length, i = t; r = Hr(i);) {
            var o = r.find();
            i = hn(e, o.from.line), n += o.from.ch - o.to.ch
        }
        for (i = t; r = Wr(i);) {
            var o = r.find();
            n -= i.text.length - o.from.ch, i = hn(e, o.to.line), n += i.text.length - o.to.ch
        }
        return n
    }
    ...
    function h(e) {
        ...
        t.maxLine = hn(r, r.first), t.maxLineLength = c(r, t.maxLine), t.maxLineChanged = !0, r.iter(function (e) {
            var n = c(r, e);
    ...
    function d(e) {
        var t = e.display, r = e.doc.height, n = r + W(t);
        t.sizer.style.minHeight = t.heightForcer.style.top = n + "px", t.gutters.style.height = Math.max(n, t.scroller.clientHeight - Co) + "px";
        var i = Math.max(n, t.scroller.scrollHeight), o = t.scroller.scrollWidth > t.scroller.clientWidth + 1,
    ...
    function p(e, t, r) {
        ...
        "number" == typeof r ? n = r : r && (n = r.top, i = r.bottom - r.top), n = Math.floor(n - H(e));
        var o = Math.ceil(n + i);
        return {from: gn(t, n), to: gn(t, o)}
    }

    function m(e) {
        var t = e.display;
        if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
            for (var r = y(t) - t.scroller.scrollLeft + e.doc.scrollLeft, n = t.gutters.offsetWidth, i = r + "px", o = t.lineDiv.firstChild; o; o = o.nextSibling) if (o.alignable) for (var l = 0, s = o.alignable; l < s.length; ++l) s[l].style.left = i;
    ...
    function b(e, t, r, n) {
        for (var i, o = e.display.showingFrom, l = e.display.showingTo, s = p(e.display, e.doc, r); x(e, t, s, n) && (n = !1, i = !0, E(e), d(e), r && (r = Math.min(e.display.scroller.scrollHeight - e.display.scroller.clientHeight, "number" == typeof r ? r : r.top)), s = p(e.display, e.doc, r), !(s.from >= e.display.showingFrom && s.to <= e.display.showingTo));) t = [];
        return i && (Rn(e, "update", e), (e.display.showingFrom != o || e.display.showingTo != l) && Rn(e, "viewportChange", e, e.display.showingFrom, e.display.showingTo)), i
    }
    ...
    function x(e, t, r, n) {
        ...
        if (!(!n && 0 == t.length && r.from > i.showingFrom && r.to < i.showingTo)) {
            g(e) && (t = [{from: o.first, to: o.first + o.size}]);
            ...
            var u = o.first + o.size, c = Math.max(r.from - e.options.viewportMargin, o.first),
                h = Math.min(u, r.to + e.options.viewportMargin);
            if (i.showingFrom < c && c - i.showingFrom < 20 && (c = Math.max(o.first, i.showingFrom)), i.showingTo > h && i.showingTo - h < 20 && (h = Math.min(u, i.showingTo)), Vi) for (c = mn(Ir(o, hn(o, c))); u > h && Pr(o, hn(o, h));) ++h;
            var f = [{from: Math.max(i.showingFrom, o.first), to: Math.min(i.showingTo, u)}];
            if (f = f[0].from >= f[0].to ? [] : C(f, t), Vi) for (var a = 0; a < f.length; ++a) for (var d, p = f[a]; d = Wr(hn(o, p.to - 1));) {
            ...
            for (var v = 0, a = 0; a < f.length; ++a) {
                var p = f[a];
                p.from < c && (p.from = c), p.to > h && (p.to = h), p.from >= p.to ? f.splice(a--, 1) : v += p.to - p.from
            }
            if (!n && v == h - c && c == i.showingFrom && h == i.showingTo) return k(e), void 0;
            f.sort(function (e, t) {
            ...
            .7 * (h - c) > v && (i.lineDiv.style.display = "none"), S(e, c, h, f, s), i.lineDiv.style.display = "", y && document.activeElement != y && y.offsetHeight && y.focus();
            var x = c != i.showingFrom || h != i.showingTo || i.lastSizeC != i.wrapper.clientHeight;
            return x && (i.lastSizeC = i.wrapper.clientHeight, D(e, 400)), i.showingFrom = c, i.showingTo = h, w(e), k(e), !0
        }
    }

    function w(e) {
        for (var t, r = e.display, n = r.lineDiv.offsetTop, i = r.lineDiv.firstChild; i; i = i.nextSibling) if (i.lineObj) {
            if (Si) {
    ...
    function k(e) {
        var t = e.display.viewOffset = vn(e, hn(e.doc, e.display.showingFrom));
        ...
        for (var r = 0, n = t.length || 0; n > r; ++r) {
            for (var i = t[r], o = [], l = i.diff || 0, s = 0, a = e.length; a > s; ++s) {
                ...
                i.to <= u.from && i.diff ? o.push({
                    ...
                    from: u.from,
                    to: i.from
                }), i.to < u.to && o.push({from: i.to + l, to: u.to + l}))
            }
            e = o
        }
        return e
    ...
    function S(e, t, r, n, i) {
        function o(t) {
            var r = t.nextSibling;
            return Ti && Ii && e.display.currentWheelTarget == t ? (t.style.display = "none", t.lineObj = null) : t.parentNode.removeChild(t), r
        }

        var l = L(e), s = e.display, a = e.options.lineNumbers;
        n.length || Ti && e.display.currentWheelTarget || ii(s.lineDiv);
        var u = s.lineDiv, c = u.firstChild, h = n.shift(), f = t;
        for (e.doc.iter(t, r, function (t) {
            if (h && h.to == f && (h = n.shift()), Pr(e.doc, t)) {
                if (0 != t.height && pn(t, 0), t.widgets && c.previousSibling) for (var r = 0; r < t.widgets.length; ++r) {
                    var s = t.widgets[r];
                    if (s.showIfHidden) {
                ...
                a && f >= i && c.lineNumber && li(c.lineNumber, v(e.options, f)), c = c.nextSibling
            } else {
                if (t.widgets) for (var g, y = 0, b = c; b && 20 > y; ++y, b = b.nextSibling) if (b.lineObj == t && /div/i.test(b.nodeName)) {
                    g = b;
                    break
                }
                var x = M(e, t, f, l, g);
                if (x != g) u.insertBefore(x, c); else {
                    for (; c != g;) c = o(c);
                    c = c.nextSibling
                }
                x.lineObj = t
    ...
    function M(e, t, r, n, i) {
        var o, l = Jr(e, t), s = t.gutterMarkers, a = e.display;
        if (!(e.options.lineNumbers || s || t.bgClass || t.wrapClass || t.widgets)) return l;
        if (i) {
            i.alignable = null;
            for (var u, c = !0, h = 0, f = null, d = i.firstChild; d; d = u) if (u = d.nextSibling, /\bCodeMirror-linewidget\b/.test(d.className)) {
                for (var p = 0; p < t.widgets.length; ++p) {
                    var m = t.widgets[p];
                    if (m.node == d.firstChild) {
                        m.above || f || (f = d), T(m, d, i, n), ++h;
                        break
                    }
                }
            ...
            i.insertBefore(l, f), c && h == t.widgets.length && (o = i, i.className = t.wrapClass || "")
        }
        if (o || (o = ni("div", null, t.wrapClass, "position: relative"), o.appendChild(l)), t.bgClass && o.insertBefore(ni("div", null, t.bgClass + " CodeMirror-linebackground"), o.firstChild), e.options.lineNumbers || s) {
            ...
            if (e.options.fixedGutter && (o.alignable || (o.alignable = [])).push(g), !e.options.lineNumbers || s && s["CodeMirror-linenumbers"] || (o.lineNumber = g.appendChild(ni("div", v(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + a.lineNumInnerWidth + "px"))), s) for (var y = 0; y < e.options.gutters.length; ++y) {
        ...
        if (Si && (o.style.zIndex = 2), t.widgets && o != i) for (var p = 0, w = t.widgets; p < w.length; ++p) {
            var m = w[p], k = ni("div", [m.node], "CodeMirror-linewidget");
    ...
    function E(e) {
        var t = e.display, r = Gt(e.doc.sel.from, e.doc.sel.to);
        if (r || e.options.showCursorWhenSelecting ? A(e) : t.cursor.style.display = t.otherCursor.style.display = "none", r ? t.selectionDiv.style.display = "none" : _(e), e.options.moveInputWithCursor) {
            var n = Y(e, e.doc.sel.head, "div"), i = si(t.wrapper), o = si(t.lineDiv);
    ...
    function A(e) {
        var t = e.display, r = Y(e, e.doc.sel.head, "div");
    ...
    function _(e) {
        ...
        function r(r, n, o) {
            function l(t, n) {
                return X(e, Ut(r, t), "div", h, n)
            }

            var u, c, h = hn(i, r), f = h.text.length;
            return hi(yn(h), n || 0, null == o ? f : o, function (e, r, i) {
                var h, d, p, m = l(e, "left");
                if (e == r) h = m, d = p = m.left; else {
                    if (h = l(r - 1, "right"), "rtl" == i) {
                        var g = m;
                        m = h, h = g
                    }
                    d = m.left, p = h.right
                }
                null == n && 0 == e && (d = a), h.top - m.top > 3 && (t(d, m.top, null, m.bottom), d = a, m.bottom < h.top && t(d, m.bottom, null, h.top)), null == o && r == f && (p = s), (!u || m.top < u.top || m.top == u.top && m.left < u.left) && (u = m), (!c || h.bottom > c.bottom || h.bottom == c.bottom && h.right > c.right) && (c = h), a + 1 > d && (d = a), t(d, h.top, p - d, h.bottom)
            }), {start: u, end: c}
        }

        var n = e.display, i = e.doc, o = e.doc.sel, l = document.createDocumentFragment(), s = n.lineSpace.offsetWidth,
            a = I(e.display);
        if (o.from.line == o.to.line) r(o.from.line, o.from.ch, o.to.ch); else {
            var u = hn(i, o.from.line), c = hn(i, o.to.line), h = Ir(i, u) == Ir(i, c),
    ...
    function D(e, t) {
        e.doc.mode.startState && e.doc.frontier < e.display.showingTo && e.state.highlight.set(t, ei(N, e))
    }

    function N(e) {
        var t = e.doc;
        if (t.frontier < t.first && (t.frontier = t.first), !(t.frontier >= e.display.showingTo)) {
            var r, n = +new Date + e.options.workTime, i = gr(t.mode, O(e, t.frontier)), o = [];
            t.iter(t.frontier, Math.min(t.first + t.size, e.display.showingTo + 500), function (l) {
                ...
                } else Yr(e, l, i), l.stateAfter = t.frontier % 5 == 0 ? gr(t.mode, i) : null;
                return ++t.frontier, +new Date > n ? (D(e, e.options.workDelay), !0) : void 0
    ...
    function z(e, t, r) {
        for (var n, i, o = e.doc, l = t, s = t - 100; l > s; --l) {
            ...
            var u = qn(a.text, null, e.options.tabSize);
    ...
    function O(e, t, r) {
        ...
        var o = z(e, t, r), l = o > n.first && hn(n, o - 1).stateAfter;
    ...
    function j(e, t) {
        ...
        var i = e.display, o = Jn(t.text.length), l = Jr(e, t, o, !0);
        if (Li && !Si && !e.options.lineWrapping && l.childNodes.length > 100) {
            for (var s = document.createDocumentFragment(), a = 10, u = l.childNodes.length, c = 0, h = Math.ceil(u / a); h > c; ++c) {
                for (var f = ni("div", null, null, "display: inline-block"), d = 0; a > d && u; ++d) f.appendChild(l.firstChild), --u;
                s.appendChild(f)
            }
            l.appendChild(s)
        }
        oi(i.measure, l);
        var p = si(i.lineDiv), m = [], g = Jn(t.text.length), v = l.offsetHeight;
    ...
    function U(e, t) {
        ...
        var o = !r && R(e, t);
        if (o) return P(e, t, t.text.length, o.measure, "right").right;
        var l = Jr(e, t, null, !0), s = l.appendChild(ci(e.display.measure));
    ...
    function K(e, t, r, n) {
        ...
        n || (n = "local");
        var l = vn(e, t);
        if ("local" == n ? l += H(e.display) : l -= e.display.viewOffset, "page" == n || "window" == n) {
            var s = si(e.display.lineSpace);
            l += s.top + ("window" == n ? 0 : V());
            var a = s.left + ("window" == n ? 0 : q());
            r.left += a, r.right += a
        }
    ...
    function Q(e, t, r) {
        ...
        if ("page" == r) n -= q(), i -= V(); else if ("local" == r || !r) {
    ...
    function X(e, t, r, n, i) {
        return n || (n = hn(e.doc, t.line)), K(e, n, P(e, n, t.ch, null, i), r)
    }

    function Y(e, t, r, n, i) {
        function o(t, o) {
            var l = P(e, n, t, i, o ? "right" : "left");
            return o ? l.left = l.right : l.right = l.left, K(e, n, l, r)
        }

        function l(e, t) {
            var r = s[t], n = r.level % 2;
            return e == fi(r) && t && r.level < s[t - 1].level ? (r = s[--t], e = di(r) - (r.level % 2 ? 0 : 1), n = !0) : e == di(r) && t < s.length - 1 && r.level < s[t + 1].level && (r = s[++t], e = fi(r) - r.level % 2, n = !1), n && e == r.to && e > r.from ? o(e - 1) : o(e, n)
        }

        n = n || hn(e.doc, t.line), i || (i = $(e, n));
        var s = yn(n), a = t.ch;
        if (!s) return o(a);
        var u = bi(s, a), c = l(a, u);
        return null != Oo && (c.other = l(a, Oo)), c
    }
    ...
    function J(e, t, r) {
        var n = e.doc;
        if (r += e.display.viewOffset, 0 > r) return Z(n.first, 0, !0, -1);
        var i = gn(n, r), o = n.first + n.size - 1;
        if (i > o) return Z(n.first + n.size - 1, hn(n, o).text.length, !0, 1);
        for (0 > t && (t = 0); ;) {
            var l = hn(n, i), s = et(e, l, i, t, r), a = Wr(l), u = a && a.find();
    ...
    function et(e, t, r, n, i) {
        function o(n) {
            var i = Y(e, Ut(r, n), "line", t, u);
            return s = !0, l > i.bottom ? i.left - a : l < i.top ? i.left + a : (s = !1, i.left)
        }

        var l = i - vn(e, t), s = !1, a = 2 * e.display.wrapper.clientWidth, u = $(e, t), c = yn(t), h = t.text.length,
            f = pi(t), d = mi(t), p = o(f), m = s, g = o(d), v = s;
        if (n > g) return Z(r, d, v, 1);
        for (; ;) {
            if (c ? d == f || d == wi(t, f, 1) : 1 >= d - f) {
                for (var y = p > n || g - n >= n - p ? f : d, b = n - (y == f ? p : g); To.test(t.text.charAt(y));) ++y;
                var x = Z(r, y, y == f ? m : v, 0 > b ? -1 : b ? 1 : 0);
                return x
            }
            var w = Math.ceil(h / 2), k = f + w;
            if (c) {
                k = f;
                for (var C = 0; w > C; ++C) k = wi(t, k, 1)
            }
            var L = o(k);
    ...
    function tt(e) {
        ...
        if (null == Bi) {
            Bi = ni("pre");
            for (var t = 0; 49 > t; ++t) Bi.appendChild(document.createTextNode("x")), Bi.appendChild(ni("br"));
            Bi.appendChild(document.createTextNode("x"))
        }
        oi(e.measure, Bi);
        var r = Bi.offsetHeight / 50;
        return r > 3 && (e.cachedTextHeight = r), ii(e.measure), r || 1
    }

    function rt(e) {
        if (null != e.cachedCharWidth) return e.cachedCharWidth;
        var t = ni("span", "x"), r = ni("pre", [t]);
        oi(e.measure, r);
        var n = t.offsetWidth;
    ...
    function ht(e) {
        ...
        var o = t.value;
        if (o == r && Gt(i.from, i.to)) return !1;
        if (Li && !Mi && e.display.inputHasSelection === o) return ft(e, !0), !1;
        var l = !e.curOp;
        l && nt(e), i.shift = !1;
        for (var s = 0, a = Math.min(r.length, o.length); a > s && r.charCodeAt(s) == o.charCodeAt(s);) ++s;
        var u = i.from, c = i.to;
        s < r.length ? u = Ut(u.line, u.ch - (r.length - s)) : e.state.overwrite && Gt(u, c) && !e.state.pasteIncoming && (c = Ut(c.line, Math.min(hn(n, c.line).text.length, c.ch + (o.length - s))));
        var h = e.curOp.updateInput,
            f = {from: u, to: c, text: Fo(o.slice(s)), origin: e.state.pasteIncoming ? "paste" : "+input"};
        return Wt(e.doc, f, "end"), e.curOp.updateInput = h, Rn(e, "inputRead", e, f), o.length > 1e3 || o.indexOf("\n") > -1 ? t.value = e.display.prevInput = "" : e.display.prevInput = o, l && it(e), e.state.pasteIncoming = !1, !0
    }

    function ft(e, t) {
        var r, n, i = e.doc;
        if (Gt(i.sel.from, i.sel.to)) t && (e.display.prevInput = e.display.input.value = "", Li && !Mi && (e.display.inputHasSelection = null)); else {
            e.display.prevInput = "", r = No && (i.sel.to.line - i.sel.from.line > 100 || (n = e.getSelection()).length > 1e3);
    ...
    function dt(e) {
        "nocursor" == e.options.readOnly || Wi && document.activeElement == e.display.input || e.display.input.focus()
    }
    ...
    function mt(e) {
        ...
        function r() {
            null == s && (s = setTimeout(function () {
                s = null, l.cachedCharWidth = l.cachedTextHeight = Ao = null, G(e), st(e, ei(at, e))
            }, 100))
        }
        ...
        function i(t) {
            Bn(e, t) || e.options.onDragEvent && e.options.onDragEvent(e, _n(t)) || zn(t)
        }

        function o() {
            l.inaccurateSelection && (l.prevInput = "", l.inaccurateSelection = !1, l.input.value = e.getSelection(), Qn(l.input))
        }

        var l = e.display;
        Wn(l.scroller, "mousedown", ot(e, yt)), Li ? Wn(l.scroller, "dblclick", ot(e, function (t) {
            if (!Bn(e, t)) {
                var r = vt(e, t);
                if (r && !bt(e, t) && !gt(e.display, t)) {
                    Fn(t);
                    var n = dr(hn(e.doc, r.line).text, r);
                    Zt(e.doc, n.from, n.to)
                }
            }
        })) : Wn(l.scroller, "dblclick", function (t) {
            Bn(e, t) || Fn(t)
        }), Wn(l.lineSpace, "selectstart", function (e) {
            gt(l, e) || Fn(e)
        }), Gi || Wn(l.scroller, "contextmenu", function (t) {
            Nt(e, t)
        }), Wn(l.scroller, "scroll", function () {
            l.scroller.clientHeight && (kt(e, l.scroller.scrollTop), Ct(e, l.scroller.scrollLeft, !0), Pn(e, "scroll", e))
        }), Wn(l.scrollbarV, "scroll", function () {
            l.scroller.clientHeight && kt(e, l.scrollbarV.scrollTop)
        }), Wn(l.scrollbarH, "scroll", function () {
            l.scroller.clientHeight && Ct(e, l.scrollbarH.scrollLeft)
        }), Wn(l.scroller, "mousewheel", function (t) {
            Lt(e, t)
        }), Wn(l.scroller, "DOMMouseScroll", function (t) {
            Lt(e, t)
        }), Wn(l.scrollbarH, "mousedown", t), Wn(l.scrollbarV, "mousedown", t), Wn(l.wrapper, "scroll", function () {
            l.wrapper.scrollTop = l.wrapper.scrollLeft = 0
        });
        var s;
        Wn(window, "resize", r), setTimeout(n, 5e3), Wn(l.input, "keyup", ot(e, function (t) {
            Bn(e, t) || e.options.onKeyEvent && e.options.onKeyEvent(e, _n(t)) || 16 == t.keyCode && (e.doc.sel.shift = !1)
        })), Wn(l.input, "input", ei(ct, e)), Wn(l.input, "keydown", ot(e, At)), Wn(l.input, "keypress", ot(e, _t)), Wn(l.input, "focus", ei(Ft, e)), Wn(l.input, "blur", ei(Dt, e)), e.options.dragDrop && (Wn(l.scroller, "dragstart", function (t) {
            wt(e, t)
        }), Wn(l.scroller, "dragenter", i), Wn(l.scroller, "dragover", i), Wn(l.scroller, "drop", ot(e, xt))), Wn(l.scroller, "paste", function (t) {
            gt(l, t) || (dt(e), ct(e))
        }), Wn(l.input, "paste", function () {
            e.state.pasteIncoming = !0, ct(e)
        }), Wn(l.input, "cut", o), Wn(l.input, "copy", o), Di && Wn(l.sizer, "mouseup", function () {
            document.activeElement == l.input && l.input.blur(), dt(e)
        })
    }

    function gt(e, t) {
        for (var r = On(t); r != e.wrapper; r = r.parentNode) if (!r || r.ignoreEvents || r.parentNode == e.sizer && r != e.mover) return !0
    }
    ...
    function yt(e) {
        function t(e) {
            if (!Gt(v, e)) {
                if (v = e, "single" == c) return Zt(i.doc, Qt(l, a), e), void 0;
                if (m = Qt(l, m), g = Qt(l, g), "double" == c) {
                    var t = dr(hn(l, e.line).text, e);
                    qt(e, m) ? Zt(i.doc, t.from, g) : Zt(i.doc, m, t.to)
                } else "triple" == c && (qt(e, m) ? Zt(i.doc, g, Qt(l, Ut(e.line, 0))) : Zt(i.doc, m, Qt(l, Ut(e.line + 1, 0))))
            }
        }
        ...
        function n(e) {
            b = 1 / 0, Fn(e), dt(i), In(document, "mousemove", x), In(document, "mouseup", w)
        }
        ...
        if (!Bn(this, e)) {
            ...
            if (!bt(i, e)) {
                ...
                if (ji && ji.time > u - 400 && Gt(ji.pos, a)) c = "triple", Fn(e), setTimeout(ei(dt, i), 20), pr(i, a.line); else if ($i && $i.time > u - 400 && Gt($i.pos, a)) {
                    c = "double", ji = {time: u, pos: a}, Fn(e);
                    var h = dr(hn(l, a.line).text, a);
                    Zt(i.doc, h.from, h.to)
                } else $i = {time: u, pos: a};
                var f = a;
                ...
                var m = s.from, g = s.to, v = a, y = si(o.wrapper), b = 0, x = ot(i, function (e) {
                    Li || Hn(e) ? r(e) : n(e)
                }), w = ot(i, n);
    ...
    function bt(e, t) {
        ...
        if (Fn(t), !jn(e, "gutterClick")) return !0;
        var o = si(r.lineDiv);
        ...
        for (var l = 0; l < e.options.gutters.length; ++l) {
            ...
            if (s && si(s).right >= n) {
                var a = gn(e.doc, i), u = e.options.gutters[l];
                Rn(e, "gutterClick", e, a, u, t);
                break
            }
        }
        return !0
    ...
    function xt(e) {
        var t = this;
        if (!(Bn(t, e) || gt(t.display, e) || t.options.onDragEvent && t.options.onDragEvent(t, _n(e)))) {
            Fn(e), Li && (Qi = +new Date);
            var r = vt(t, e, !0), n = e.dataTransfer.files;
            if (r && !pt(t)) if (n && n.length && window.FileReader && window.File) for (var i = n.length, o = Array(i), l = 0, s = function (e, n) {
                var s = new FileReader;
                s.onload = function () {
                    o[n] = s.result, ++l == i && (r = Qt(t.doc, r), Wt(t.doc, {
                        from: r,
                        to: r,
                        text: Fo(o.join("\n")),
                        origin: "paste"
            ...
            }, a = 0; i > a; ++a) s(n[a], a); else {
                if (t.state.draggingText && !qt(r, t.doc.sel.from) && !qt(t.doc.sel.to, r)) return t.state.draggingText(e), setTimeout(ei(dt, t), 20), void 0;
                try {
                    var o = e.dataTransfer.getData("Text");
                    if (o) {
                        var u = t.doc.sel.from, c = t.doc.sel.to;
                        er(t.doc, r, r), t.state.draggingText && jt(t.doc, "", u, c, "paste"), t.replaceSelection(o, null, "paste"), dt(t), Ft(t)
                    }
                } catch (e) {
                }
            }
    ...
    function wt(e, t) {
        if (Li && (!e.state.draggingText || +new Date - Qi < 100)) return zn(t), void 0;
        if (!Bn(e, t) && !gt(e.display, t)) {
            var r = e.getSelection();
            if (t.dataTransfer.setData("Text", r), t.dataTransfer.setDragImage && !Fi) {
    ...
    function kt(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (e.doc.scrollTop = t, Ci || b(e, [], t), e.display.scroller.scrollTop != t && (e.display.scroller.scrollTop = t), e.display.scrollbarV.scrollTop != t && (e.display.scrollbarV.scrollTop = t), Ci && b(e, []), D(e, 100))
    }
    ...
    function Lt(e, t) {
        ...
        if (r && o.scrollWidth > o.clientWidth || n && o.scrollHeight > o.clientHeight) {
            if (n && Ii && Ti) for (var l = t.target; l != o; l = l.parentNode) if (l.lineObj) {
                e.display.currentWheelTarget = l;
                break
            }
            if (r && !Ci && !_i && null != Yi) return n && kt(e, Math.max(0, Math.min(o.scrollTop + n * Yi, o.scrollHeight - o.clientHeight))), Ct(e, Math.max(0, Math.min(o.scrollLeft + r * Yi, o.scrollWidth - o.clientWidth))), Fn(t), i.wheelStartX = null, void 0;
            if (n && null != Yi) {
                var s = n * Yi, a = e.doc.scrollTop, u = a + i.wrapper.clientHeight;
                0 > s ? a = Math.max(0, a + s - 50) : u = Math.min(e.doc.height, u + s + 50), b(e, [], {
                    top: a,
                    bottom: u
                })
            }
            20 > Xi && (null == i.wheelStartX ? (i.wheelStartX = o.scrollLeft, i.wheelStartY = o.scrollTop, i.wheelDX = r, i.wheelDY = n, setTimeout(function () {
                if (null != i.wheelStartX) {
                    ...
                    i.wheelStartX = i.wheelStartY = null, r && (Yi = (Yi * Xi + r) / (Xi + 1), ++Xi)
                }
    ...
    function St(e, t, r) {
        ...
        try {
            pt(e) && (e.state.suppressEdits = !0), r && (n.sel.shift = !1), o = t(e) != Lo
        } finally {
    ...
    function Tt(e, t) {
        var r = yr(e.options.keyMap), n = r.auto;
        clearTimeout(Zi), n && !xr(t) && (Zi = setTimeout(function () {
        ...
        return o = t.shiftKey ? br("Shift-" + i, s, function (t) {
            ...
            return St(e, t)
        }), o && (Fn(t), F(e), Mi && (t.oldKeyCode = t.keyCode, t.keyCode = 0), Rn(e, "keyHandled", e, i, t)), o
    }
    ...
    function Et(e, t, r) {
        ...
        return n && (Fn(t), F(e), Rn(e, "keyHandled", e, "'" + r + "'", t)), n
    }

    function At(e) {
        var t = this;
        if (t.state.focused || Ft(t), Li && 27 == e.keyCode && (e.returnValue = !1), !(Bn(t, e) || t.options.onKeyEvent && t.options.onKeyEvent(t, _n(e)))) {
            var r = e.keyCode;
    ...
    function _t(e) {
        var t = this;
        if (!(Bn(t, e) || t.options.onKeyEvent && t.options.onKeyEvent(t, _n(e)))) {
            var r = e.keyCode, n = e.charCode;
            if (_i && r == eo) return eo = null, Fn(e), void 0;
            if (!(_i && (!e.which || e.which < 10) || Di) || !Tt(t, e)) {
                ...
                }), 75), Et(t, e, i) || (Li && !Mi && (t.display.inputHasSelection = null), ct(t))
            }
        }
    }

    function Ft(e) {
        "nocursor" != e.options.readOnly && (e.state.focused || (Pn(e, "focus", e), e.state.focused = !0, -1 == e.display.wrapper.className.search(/\bCodeMirror-focused\b/) && (e.display.wrapper.className += " CodeMirror-focused"), ft(e, !0)), ut(e), F(e))
    }

    function Dt(e) {
        e.state.focused && (Pn(e, "blur", e), e.state.focused = !1, e.display.wrapper.className = e.display.wrapper.className.replace(" CodeMirror-focused", "")), clearInterval(e.display.blinker), setTimeout(function () {
    ...
    function Nt(e, t) {
        function r() {
            if (null != i.input.selectionStart) {
                var e = i.input.value = " " + (Gt(o.from, o.to) ? "" : i.input.value);
        ...
        function n() {
            if (i.inputDiv.style.position = "relative", i.input.style.cssText = a, Mi && (i.scrollbarV.scrollTop = i.scroller.scrollTop = s), ut(e), null != i.input.selectionStart) {
                (!Li || Mi) && r(), clearTimeout(Ji);
                var t = 0, n = function () {
                    " " == i.prevInput && 0 == i.input.selectionStart ? ot(e, co.selectAll)(e) : t++ < 10 ? Ji = setTimeout(n, 500) : ft(e)
                };
                Ji = setTimeout(n, 200)
            }
        }

        if (!Bn(e, t, "contextmenu")) {
            var i = e.display, o = e.doc.sel;
            if (!gt(i, t)) {
                var l = vt(e, t), s = i.scroller.scrollTop;
                if (l && !_i) {
                    (Gt(o.from, o.to) || qt(l, o.from) || !qt(l, o.to)) && ot(e, er)(e.doc, l, l);
                    var a = i.input.style.cssText;
                    if (i.inputDiv.style.position = "absolute", i.input.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (t.clientY - 5) + "px; left: " + (t.clientX - 5) + "px; z-index: 1000; background: white; outline: none;border-width: 0; outline: none; overflow: hidden; opacity: .05; -ms-opacity: .05; filter: alpha(opacity=5);", dt(e), ft(e, !0), Gt(o.from, o.to) && (i.input.value = i.prevInput = " "), Li && !Mi && r(), Gi) {
                        zn(t);
                        var u = function () {
                            In(window, "mouseup", u), setTimeout(n, 20)
                        };
                        Wn(window, "mouseup", u)
    ...
    function zt(e, t, r) {
        if (!qt(t.from, r)) return Qt(e, r);
        var n = t.text.length - 1 - (t.to.line - t.from.line);
        if (r.line > t.to.line + n) {
            var i = r.line - n, o = e.first + e.size - 1;
            return i > o ? Ut(o, hn(e, o).text.length) : Xt(r, hn(e, i).text.length)
        }
        if (r.line == t.to.line + n) return Xt(r, Kn(t.text).length + (1 == t.text.length ? t.from.ch : 0) + hn(e, t.to.line).text.length - t.to.ch);
        var l = r.line - t.from.line;
        return Xt(r, t.text[l].length + (l ? 0 : t.from.ch))
    }

    function Ot(e, t, r) {
        if (r && "object" == typeof r) return {anchor: zt(e, t, r.anchor), head: zt(e, t, r.head)};
        if ("start" == r) return {anchor: t.from, head: t.from};
        var n = to(t);
        if ("around" == r) return {anchor: t.from, head: n};
        if ("end" == r) return {anchor: n, head: n};
        var i = function (e) {
    ...
    function Ht(e, t, r) {
        ...
        return r && (n.update = function (t, r, n, i) {
            t && (this.from = Qt(e, t)), r && (this.to = Qt(e, r)), n && (this.text = n), void 0 !== i && (this.origin = i)
        }), Pn(e, "beforeChange", e, n), e.cm && Pn(e.cm, "beforeChange", e.cm, n), n.canceled ? null : {
            from: n.from,
            to: n.to,
            text: n.text,
            origin: n.origin
    ...
    function Wt(e, t, r, n) {
        if (e.cm) {
            if (!e.cm.curOp) return ot(e.cm, Wt)(e, t, r, n);
            if (e.cm.state.suppressEdits) return
        }
        if (!(jn(e, "beforeChange") || e.cm && jn(e.cm, "beforeChange")) || (t = Ht(e, t, !0))) {
            var i = qi && !n && zr(e, t.from, t.to);
            if (i) {
                for (var o = i.length - 1; o >= 1; --o) It(e, {from: i[o].from, to: i[o].to, text: [""]});
                i.length && It(e, {from: i[0].from, to: i[0].to, text: t.text}, r)
            } else It(e, t, r)
        }
    }
    ...
    function It(e, t, r) {
        var n = Ot(e, t, r);
        kn(e, t, n, e.cm ? e.cm.curOp.id : 0 / 0), Bt(e, t, n, Dr(e, t));
        var i = [];
        un(e, function (e, r) {
            r || -1 != Xn(i, e.history) || (En(e.history, t), i.push(e.history)), Bt(e, t, null, Dr(e, t))
        })
    }
        ...
        if (!e.cm || !e.cm.state.suppressEdits) {
            ...
            if (n) {
                ...
                for (var o = jn(e, "beforeChange") || e.cm && jn(e.cm, "beforeChange"), l = n.changes.length - 1; l >= 0; --l) {
                    var s = n.changes[l];
                    if (s.origin = t, o && !Ht(e, s, !1)) return ("undo" == t ? r.done : r.undone).length = 0, void 0;
                    i.changes.push(wn(e, s));
                    var a = l ? Ot(e, s, null) : {anchor: n.anchorBefore, head: n.headBefore};
                    Bt(e, s, a, Nr(e, s));
                    var u = [];
                    un(e, function (e, t) {
                        t || -1 != Xn(u, e.history) || (En(e.history, s), u.push(e.history)), Bt(e, s, null, Nr(e, s))
                    })
                }
            }
        }
    ...
    function Bt(e, t, r, n) {
        if (e.cm && !e.cm.curOp) return ot(e.cm, Bt)(e, t, r, n);
        if (t.to.line < e.first) return Rt(e, t.text.length - 1 - (t.to.line - t.from.line)), void 0;
        if (!(t.from.line > e.lastLine())) {
            ...
            t.to.line > o && (t = {
                from: t.from,
                to: Ut(o, hn(e, o).text.length),
                text: [t.text[0]],
                origin: t.origin
            }), t.removed = fn(e, t.from, t.to), r || (r = Ot(e, t, null)), e.cm ? $t(e.cm, t, n, r) : ln(e, t, n, r)
        }
    }

    function $t(e, t, r, n) {
        var o = e.doc, l = e.display, s = t.from, a = t.to, u = !1, h = s.line;
        e.options.lineWrapping || (h = mn(Ir(o, hn(o, s.line))), o.iter(h, a.line + 1, function (e) {
            return e == l.maxLine ? (u = !0, !0) : void 0
        })), qt(o.sel.head, t.from) || qt(t.to, o.sel.head) || (e.curOp.cursorActivity = !0), ln(o, t, r, n, i(e)), e.options.lineWrapping || (o.iter(h, s.line + t.text.length, function (e) {
            var t = c(o, e);
            t > l.maxLineLength && (l.maxLine = e, l.maxLineLength = t, l.maxLineChanged = !0, u = !1)
        }), u && (e.curOp.updateMaxLine = !0)), o.frontier = Math.min(o.frontier, s.line), D(e, 400);
        var f = t.text.length - (a.line - s.line) - 1;
        if (at(e, s.line, a.line + 1, f), jn(e, "change")) {
            var d = {from: s, to: a, text: t.text, removed: t.removed, origin: t.origin};
    ...
    function jt(e, t, r, n, i) {
        ...
        "string" == typeof t && (t = Fo(t)), Wt(e, {from: r, to: n, text: t, origin: i}, null)
    }
    ...
    function Qt(e, t) {
        ...
        return t.line > r ? Ut(r, hn(e, r).text.length) : Xt(t, hn(e, t.line).text.length)
    }
    ...
    function Jt(e, t, r) {
        var n = {anchor: t, head: r};
        return Pn(e, "beforeSelectionChange", e, n), e.cm && Pn(e.cm, "beforeSelectionChange", e.cm, n), n.anchor = Qt(e, n.anchor), n.head = Qt(e, n.head), n
    }
    ...
    function er(e, t, r, n, i) {
        ...
        var l = e.sel;
        if (l.goalColumn = null, (i || !Gt(t, l.anchor)) && (t = rr(e, t, n, "push" != i)), (i || !Gt(r, l.head)) && (r = rr(e, r, n, "push" != i)), !Gt(l.anchor, t) || !Gt(l.head, r)) {
            l.anchor = t, l.head = r;
            var s = qt(r, t);
        ...
        e:for (; ;) {
            ...
            if (s.markedSpans) for (var a = 0; a < s.markedSpans.length; ++a) {
                ...
                if ((null == u.from || (c.inclusiveLeft ? u.from <= o.ch : u.from < o.ch)) && (null == u.to || (c.inclusiveRight ? u.to >= o.ch : u.to > o.ch))) {
                    if (n && (Pn(c, "beforeCursorEnter"), c.explicitlyCleared)) {
                        if (s.markedSpans) {
                            --a;
                            continue
                        }
                    ...
                    var h = c.find()[0 > l ? "from" : "to"];
                    if (Gt(h, o) && (h.ch += l, h.ch < 0 ? h = h.line > e.first ? Qt(e, Ut(h.line - 1)) : null : h.ch > s.text.length && (h = h.line < e.first + e.size - 1 ? Ut(h.line + 1, 0) : null), !h)) {
    ...
    function nr(e) {
        ...
        if (e.state.focused) {
            var r = e.display, n = si(r.sizer), i = null;
            if (t.top + n.top < 0 ? i = !0 : t.bottom + n.top > (window.innerHeight || document.documentElement.clientHeight) && (i = !1), null != i && !Oi) {
    ...
    function ir(e, t, r) {
        for (null == r && (r = 0); ;) {
            var n = !1, i = Y(e, t), o = lr(e, i.left, i.top - r, i.left, i.bottom + r), l = e.doc.scrollTop,
                s = e.doc.scrollLeft;
            if (null != o.scrollTop && (kt(e, o.scrollTop), Math.abs(e.doc.scrollTop - l) > 1 && (n = !0)), null != o.scrollLeft && (Ct(e, o.scrollLeft), Math.abs(e.doc.scrollLeft - s) > 1 && (n = !0)), !n) return i
        }
    }
    ...
    function lr(e, t, r, n, i) {
        var o = e.display, l = tt(e.display);
        0 > r && (r = 0);
        var s = o.scroller.clientHeight - Co, a = o.scroller.scrollTop, u = {}, c = e.doc.height + W(o), h = l > r,
            f = i > c - l;
        if (a > r) u.scrollTop = h ? 0 : r; else if (i > a + s) {
            var d = Math.min(r, (f ? c : i) - s);
            d != a && (u.scrollTop = d)
        }
        var p = o.scroller.clientWidth - Co, m = o.scroller.scrollLeft;
    ...
    function ur(e, t, r, n) {
        var i = e.doc;
        if (null == r && (r = "add"), "smart" == r) if (e.doc.mode.indent) var o = O(e, t); else r = "prev";
        var l, s = e.options.tabSize, a = hn(i, t), u = qn(a.text, null, s), c = a.text.match(/^\s*/)[0];
        if ("smart" == r && (l = e.doc.mode.indent(o, a.text.slice(c.length), a.text), l == Lo)) {
            if (!n) return;
            r = "prev"
        }
        "prev" == r ? l = t > i.first ? qn(hn(i, t - 1).text, null, s) : 0 : "add" == r ? l = u + e.options.indentUnit : "subtract" == r ? l = u - e.options.indentUnit : "number" == typeof r && (l = u + r), l = Math.max(0, l);
        var h = "", f = 0;
        if (e.options.indentWithTabs) for (var d = Math.floor(l / s); d; --d) f += s, h += "	";
        l > f && (h += Vn(l - f)), h != c && jt(e.doc, h, Ut(t, 0), Ut(t, c.length), "+input"), a.stateAfter = null
    }

    function cr(e, t, r) {
        var n = t, i = t, o = e.doc;
        return "number" == typeof t ? i = hn(o, Kt(o, t)) : n = mn(t), null == n ? null : r(i, n) ? (at(e, n, n + 1), i) : null
    }

    function hr(e, t, r, n, i) {
        function o() {
            var t = s + r;
            return t < e.first || t >= e.first + e.size ? h = !1 : (s = t, c = hn(e, t))
        }

        function l(e) {
            var t = (i ? wi : ki)(c, a, r, !0);
            if (null == t) {
                if (e || !o()) return h = !1;
        ...
        var s = t.line, a = t.ch, u = r, c = hn(e, s), h = !0;
        if ("char" == n) l(); else if ("column" == n) l(!0); else if ("word" == n || "group" == n) for (var f = null, d = "group" == n, p = !0; !(0 > r) || l(!p); p = !1) {
            var m = c.text.charAt(a) || "\n", g = ti(m) ? "w" : d ? /\s/.test(m) ? null : "p" : null;
            if (f && f != g) {
                0 > r && (r = 1, l());
                break
            }
            if (g && (f = g), r > 0 && !l(!p)) break
        }
        var v = rr(e, Ut(s, a), u, !0);
        return h || (v.hitSide = !0), v
    }
    ...
    function dr(e, t) {
        ...
        return {from: Ut(t.line, r), to: Ut(t.line, n)}
    }

    function pr(e, t) {
        Zt(e.doc, Ut(t, 0), Qt(e.doc, Ut(t + 1, 0)))
    }
    ...
    function wr(e, t) {
        if (_i && 34 == e.keyCode && e["char"]) return !1;
        var r = zo[e.keyCode];
    ...
    function Lr(e, t, r, n, i) {
        ...
        if (e.cm && !e.cm.curOp) return ot(e.cm, Lr)(e, t, r, n, i);
        var o = new Cr(e, i);
        if ("range" == i && !qt(t, r)) return o;
        n && Zn(n, o), o.replacedWith && (o.collapsed = !0, o.replacedWith = ni("span", [o.replacedWith], "CodeMirror-widget"), n.handleMouseEvents || (o.replacedWith.ignoreEvents = !0)), o.collapsed && (Vi = !0), o.addToHistory && kn(e, {
            from: t,
            to: r,
            origin: "markText"
        }, {head: e.sel.head, anchor: e.sel.anchor}, 0 / 0);
        var l, s, a, u = t.line, c = 0, h = e.cm;
        if (e.iter(u, r.line + 1, function (n) {
            h && o.collapsed && !h.options.lineWrapping && Ir(e, n) == h.display.maxLine && (a = !0);
            var i = {from: null, to: null, marker: o};
            c += n.text.length, u == t.line && (i.from = t.ch, c -= t.ch), u == r.line && (i.to = r.ch, c -= n.text.length - r.ch), o.collapsed && (u == r.line && (s = Or(n, r.ch)), u == t.line ? l = Or(n, t.ch) : pn(n, 0)), Ar(n, i), ++u
        }), o.collapsed && e.iter(t.line, r.line + 1, function (t) {
            Pr(e, t) && pn(t, 0)
        }), o.clearOnEnter && Wn(o, "beforeCursorEnter", function () {
            o.clear()
        ...
        return h && (a && (h.curOp.updateMaxLine = !0), (o.className || o.title || o.startStyle || o.endStyle || o.collapsed) && at(h, t.line, r.line + 1), o.atomic && tr(h)), o
    }

    function Sr(e, t) {
        this.markers = e, this.primary = t;
        for (var r = 0, n = this; r < e.length; ++r) e[r].parent = this, Wn(e[r], "clear", function () {
            n.clear()
        })
    }
    ...
    function Mr(e, t, r, n, i) {
        n = Zn(n), n.shared = !1;
        var o = [Lr(e, t, r, n, i)], l = o[0], s = n.replacedWith;
        return un(e, function (e) {
            s && (n.replacedWith = s.cloneNode(!0)), o.push(Lr(e, Qt(e, t), Qt(e, r), n, i));
    ...
    function Dr(e, t) {
        var r = Yt(e, t.from.line) && hn(e, t.from.line).markedSpans,
            n = Yt(e, t.to.line) && hn(e, t.to.line).markedSpans;
        if (!r && !n) return null;
        var i = t.from.ch, o = t.to.ch, l = Gt(t.from, t.to), s = _r(r, i, l), a = Fr(n, o, l), u = 1 == t.text.length,
            c = Kn(t.text).length + (u ? i : 0);
        ...
        if (u && s) {
            for (var h = 0; h < s.length; ++h) null != s[h].from && s[h].from == s[h].to && "bookmark" != s[h].marker.type && s.splice(h--, 1);
            s.length || (s = null)
        }
        var p = [s];
        if (!u) {
            var m, g = t.text.length - 2;
            if (g > 0 && s) for (var h = 0; h < s.length; ++h) null == s[h].to && (m || (m = [])).push({
                from: null,
                to: null,
                marker: s[h].marker
            });
    ...
    function zr(e, t, r) {
        ...
        if (e.iter(t.line, r.line + 1, function (e) {
            if (e.markedSpans) for (var t = 0; t < e.markedSpans.length; ++t) {
                ...
                !r.readOnly || n && -1 != Xn(n, r) || (n || (n = [])).push(r)
            }
        }), !n) return null;
        for (var i = [{
            from: t,
            ...
            var u = i[a];
            if (!qt(u.to, s.from) && !qt(s.to, u.from)) {
                var c = [a, 1];
                (qt(u.from, s.from) || !l.inclusiveLeft && Gt(u.from, s.from)) && c.push({
                    from: u.from,
                    to: s.from
                }), (qt(s.to, u.to) || !l.inclusiveRight && Gt(u.to, s.to)) && c.push({
                    from: s.to,
                    to: u.to
    ...
    function Or(e, t) {
        ...
        if (n) for (var i, o = 0; o < n.length; ++o) i = n[o], i.marker.collapsed && (null == i.from || i.from < t) && (null == i.to || i.to > t) && (!r || r.width < i.marker.width) && (r = i.marker);
        return r
    }
    ...
    function Wr(e) {
        return Or(e, e.text.length + 1)
    }

    function Ir(e, t) {
        for (var r; r = Hr(t);) t = hn(e, r.find().from.line);
        return t
    }
    ...
    function Rr(e, t, r) {
        if (null == r.to) {
            var n = r.marker.find().to, i = hn(e, n.line);
    ...
    function Gr(e, t, r, n) {
        ...
        return i.noHScroll && (e.display.alignWidgets = !0), cr(e, t, function (t) {
            ...
            if (null == i.insertAt ? r.push(i) : r.splice(Math.min(r.length - 1, Math.max(0, i.insertAt)), 0, i), i.line = t, !Pr(e.doc, t) || i.showIfHidden) {
    ...
    function qr(e, t, r, n) {
        e.text = t, e.stateAfter && (e.stateAfter = null), e.styles && (e.styles = null), null != e.order && (e.order = null), Br(e), $r(e, r);
        var i = n ? n(e) : 1;
        i != e.height && pn(e, i)
    }
    ...
    function Kr(e, t, r, n, i) {
        ...
        var l, s = 0, a = null, u = new kr(t, e.options.tabSize);
    ...
    function Qr(e, t, r) {
        ...
        for (var i = 0; i < e.state.overlays.length; ++i) {
            ...
            Kr(e, t.text, o.mode, !0, function (e, t) {
                for (var r = l; e > s;) {
                    var i = n[l];
                    i > e && n.splice(l, 1, e, n[l + 1], i), l += 2, s = Math.min(e, i)
                }
                if (t) if (o.opaque) n.splice(r, l - r, e, t), l = r + 2; else for (; l > r; r += 2) {
                    var a = n[r + 1];
                    n[r + 1] = a ? a + " " + t : t
                }
            })
    ...
    function Xr(e, t) {
        return t.styles && t.styles[0] == e.state.modeGen || (t.styles = Qr(e, t, t.stateAfter = O(e, mn(t)))), t.styles
    }

    function Yr(e, t, r) {
        var n = e.doc.mode, i = new kr(t.text, e.options.tabSize);
    ...
    function Jr(e, t, r, n) {
        for (var i, o = t, l = !0; i = Hr(o);) o = hn(e.doc, i.find().from.line);
        var s = {pre: ni("pre"), col: 0, pos: 0, measure: null, measuredSomething: !1, cm: e, copyWidgets: n};
        o.textClass && (s.pre.className = o.textClass);
        do {
            o.text && (l = !1), s.measure = o == t && r, s.pos = 0, s.addToken = s.measure ? tn : en, (Li || Ti) && e.getOption("lineWrapping") && (s.addToken = rn(s.addToken));
            var a = on(o, s, Xr(e, o));
            r && o == t && !s.measuredSomething && (r[0] = s.pre.appendChild(ci(e.display.measure)), s.measuredSomething = !0), a && (o = hn(e.doc, a.to.line))
        } while (a);
        !r || s.measuredSomething || r[0] || (r[0] = s.pre.appendChild(l ? ni("span", " ") : ci(e.display.measure))), s.pre.firstChild || Pr(e.doc, t) || s.pre.appendChild(document.createTextNode(" "));
        var u;
        if (r && Li && (u = yn(o))) {
            var c = u.length - 1;
            u[c].from == u[c].to && --c;
            var h = u[c], f = u[c - 1];
            if (h.from + 1 == h.to && f && h.level < f.level) {
                var d = r[s.pos - 1];
                d && d.parentNode.insertBefore(d.measureRight = ci(e.display.measure), d.nextSibling)
            }
        }
        return Pn(e, "renderLine", e, t, s.pre), s.pre
    }

    function en(e, t, r, n, i, o) {
        if (t) {
            if (go.test(t)) for (var l = document.createDocumentFragment(), s = 0; ;) {
                go.lastIndex = s;
                var a = go.exec(t), u = a ? a.index - s : t.length - s;
                if (u && (l.appendChild(document.createTextNode(t.slice(s, s + u))), e.col += u), !a) break;
                if (s += u + 1, "	" == a[0]) {
                    var c = e.cm.options.tabSize, h = c - e.col % c;
                    l.appendChild(ni("span", Vn(h), "cm-tab")), e.col += h
                } else {
                    var f = ni("span", "•", "cm-invalidchar");
                    f.title = "\\u" + a[0].charCodeAt(0).toString(16), l.appendChild(f), e.col += 1
                }
            } else {
                e.col += t.length;
            ...
            if (r || n || i || e.measure) {
                ...
                n && (d += n), i && (d += i);
                var f = ni("span", [l], d);
                return o && (f.title = o), e.pre.appendChild(f)
            }
            e.pre.appendChild(l)
        }
    }
    ...
    function tn(e, t, r, n, i) {
        for (var o = e.cm.options.lineWrapping, l = 0; l < t.length; ++l) {
            ...
            var u = e.measure[e.pos], c = e.measure[e.pos] = en(e, s, r, a && n, l == t.length - 1 && i);
    ...
    function on(e, t, r) {
        ...
        if (n) for (var l, s, a, u, c, h, f = i.length, d = 0, p = 1, m = "", g = 0; ;) {
            if (g == d) {
                s = a = u = c = "", h = null, g = 1 / 0;
                for (var v = null, y = 0; y < n.length; ++y) {
                    var b = n[y], x = b.marker;
                    b.from <= d && (null == b.to || b.to > d) ? (null != b.to && g > b.to && (g = b.to, a = ""), x.className && (s += " " + x.className), x.startStyle && b.from == d && (u += " " + x.startStyle), x.endStyle && b.to == g && (a += " " + x.endStyle), x.title && !c && (c = x.title), x.collapsed && (!h || h.marker.size < x.size) && (h = b)) : b.from > d && g > b.from && (g = b.from), "bookmark" == x.type && b.from == d && x.replacedWith && (v = x)
                }
                if (h && (h.from || 0) == d && (nn(t, (null == h.to ? f : h.to) - d, h.marker, null == h.from), null == h.to)) return h.marker.find();
                v && !h && nn(t, 0, v)
            }
            if (d >= f) break;
            for (var w = Math.min(f, g); ;) {
                if (m) {
                    var k = d + m.length;
                    if (!h) {
                        var C = k > w ? m.slice(0, w - d) : m;
                        t.addToken(t, C, l ? l + s : s, u, d + C.length == g ? a : "", c)
                    }
                    if (k >= w) {
                        m = m.slice(w - d), d = w;
                        break
                ...
                m = i.slice(o, o = r[p++]), l = Zr(r[p++])
            }
        } else for (var p = 1; p < r.length; p += 2) t.addToken(t, i.slice(o, o = r[p]), Zr(r[p + 1]))
    }
    ...
    function ln(e, t, r, n, i) {
        ...
        function l(e, r, n) {
            qr(e, r, n, i), Rn(e, "change", e, t)
        }

        var s = t.from, a = t.to, u = t.text, c = hn(e, s.line), h = hn(e, a.line), f = Kn(u), d = o(u.length - 1),
            p = a.line - s.line;
        if (0 == s.ch && 0 == a.ch && "" == f) {
            for (var m = 0, g = u.length - 1, v = []; g > m; ++m) v.push(new po(u[m], o(m), i));
            l(h, h.text, d), p && e.remove(s.line, p), v.length && e.insert(s.line, v)
        } else if (c == h) if (1 == u.length) l(c, c.text.slice(0, s.ch) + f + c.text.slice(a.ch), d); else {
        ...
        } else if (1 == u.length) l(c, c.text.slice(0, s.ch) + u[0] + h.text.slice(a.ch), o(0)), e.remove(s.line + 1, p); else {
            l(c, c.text.slice(0, s.ch) + u[0], o(0)), l(h, f + h.text.slice(a.ch), d);
    ...
    function mn(e) {
        ...
        for (var t = e.parent, r = Xn(t.lines, e), n = t.parent; n; t = n, n = n.parent) for (var i = 0; n.children[i] != t; ++i) r += n.children[i].chunkSize();
        return r + t.first
    }
    ...
    function yn(e) {
        var t = e.order;
        return null == t && (t = e.order = Ho(e.text)), t
    }
    ...
    function wn(e, t) {
        var r = {line: t.from.line, ch: t.from.ch}, n = {from: r, to: to(t), text: fn(e, t.from, t.to)};
    ...
    function kn(e, t, r, n) {
        ...
        if (l && (i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && e.cm && i.lastTime > o - e.cm.options.historyEventDelay || "*" == t.origin.charAt(0)))) {
            var s = Kn(l.changes);
            Gt(t.from, t.to) && Gt(t.from, s.to) ? s.to = to(t) : l.changes.push(wn(e, t)), l.anchorAfter = r.anchor, l.headAfter = r.head
        } else for (l = {
            changes: [wn(e, t)],
    ...
    function Ln(e, t) {
        var r = t["spans_" + e.id];
        if (!r) return null;
        for (var n = 0, i = []; n < t.text.length; ++n) i.push(Cn(r[n]));
        return i
    }
        ...
        for (var r = 0, n = []; r < e.length; ++r) {
            ...
            for (var s = 0; s < o.length; ++s) {
                ...
                if (l.push({
                    ...
                    to: u.to,
                    text: u.text
                }), t) for (var c in u) (a = c.match(/^spans_(\d+)$/)) && Xn(t, Number(a[1])) > -1 && (Kn(l)[c] = u[c], delete u[c])
            }
        }
        return n
    }
    ...
    function Tn(e, t, r, n) {
        for (var i = 0; i < e.length; ++i) {
            for (var o = e[i], l = !0, s = 0; s < o.changes.length; ++s) {
                var a = o.changes[s];
                if (o.copied || (a.from = Vt(a.from), a.to = Vt(a.to)), r < a.from.line) a.from.line += n, a.to.line += n; else if (t <= a.to.line) {
                    l = !1;
                    break
                }
            }
    ...
    function Hn(e) {
        var t = e.which;
        return null == t && (1 & e.button ? t = 1 : 2 & e.button ? t = 3 : 4 & e.button && (t = 2)), Ii && e.ctrlKey && 1 == t && (t = 3), t
    }
    ...
    function Rn(e, t) {
        ...
        if (n) {
            ...
            wo || (++ko, wo = [], setTimeout($n, 0));
            for (var o = 0; o < n.length; ++o) wo.push(r(n[o]))
        }
    }

    function Bn(e, t, r) {
        return Pn(e, r || t.type, e, t), Nn(t) || t.codemirrorIgnore
    }
    ...
    function Qn(e) {
        if (Hi) e.selectionStart = 0, e.selectionEnd = e.value.length; else try {
            e.select()
        } catch (t) {
        }
    }
    ...
    function ni(e, t, r, n) {
        ...
        if (r && (i.className = r), n && (i.style.cssText = n), "string" == typeof t) li(i, t); else if (t) for (var o = 0; o < t.length; ++o) i.appendChild(t[o]);
        return i
    }
    ...
    function ui(e) {
        ...
        return oi(e, t), t.offsetWidth && (Ao = t.offsetHeight - t.clientHeight), Ao || 0
    }

    function ci(e) {
        if (null == _o) {
            var t = ni("span", "​");
            oi(e, ni("span", [t, document.createTextNode("x")])), 0 != e.firstChild.offsetHeight && (_o = t.offsetWidth <= 1 && t.offsetHeight > 2 && !Si)
        }
        return _o ? ni("span", "​") : ni("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px")
    }
    ...
    function mi(e) {
        var t = yn(e);
        return t ? di(Kn(t)) : e.text.length
    }

    function gi(e, t) {
        var r = hn(e.doc, t), n = Ir(e.doc, r);
        n != r && (t = mn(n));
        var i = yn(n), o = i ? i[0].level % 2 ? mi(n) : pi(n) : 0;
        return Ut(t, o)
    }

    function vi(e, t) {
        for (var r, n; r = Wr(n = hn(e.doc, t));) t = r.find().to.line;
        var i = yn(n), o = i ? i[0].level % 2 ? pi(n) : mi(n) : n.text.length;
        return Ut(t, o)
    }
    ...
    function bi(e, t) {
        for (var r, n = 0; n < e.length; ++n) {
            var i = e[n];
            if (i.from < t && i.to > t) return Oo = null, n;
            if (i.from == t || i.to == t) {
                if (null != r) return yi(e, i.level, e[r].level) ? (Oo = r, n) : (Oo = n, r);
                r = n
            }
        }
        return Oo = null, r
    ...
    var Ci = /gecko\/\d/i.test(navigator.userAgent), Li = /MSIE \d/.test(navigator.userAgent),
        Si = Li && (null == document.documentMode || document.documentMode < 8),
        Mi = Li && (null == document.documentMode || document.documentMode < 9),
        Ti = /WebKit\//.test(navigator.userAgent), Ei = Ti && /Qt\/\d+\.\d+/.test(navigator.userAgent),
        Ai = /Chrome\//.test(navigator.userAgent), _i = /Opera\//.test(navigator.userAgent),
        Fi = /Apple Computer/.test(navigator.vendor), Di = /KHTML\//.test(navigator.userAgent),
        Ni = /Mac OS X 1\d\D([7-9]|\d\d)\D/.test(navigator.userAgent),
        zi = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(navigator.userAgent), Oi = /PhantomJS/.test(navigator.userAgent),
        ...
        Ii = Hi || /Mac/.test(navigator.platform), Pi = /windows/i.test(navigator.platform),
        Ri = _i && navigator.userAgent.match(/Version\/(\d*\.\d*)/);
    Ri && (Ri = Number(Ri[1])), Ri && Ri >= 15 && (_i = !1, Ti = !0);
    var Bi, $i, ji, Ui = Ii && (Ei || _i && (null == Ri || 12.11 > Ri)), Gi = Ci || Li && !Mi, qi = !1, Vi = !1, Ki = 0,
        Qi = 0, Xi = 0, Yi = null;
    Li ? Yi = -.53 : Ci ? Yi = 15 : Ai ? Yi = -.7 : Fi && (Yi = -1 / 3);
    var Zi, Ji, eo = null, to = e.changeEnd = function (e) {
        return e.text ? Ut(e.from.line + e.text.length - 1, Kn(e.text).length + (1 == e.text.length ? e.from.ch : 0)) : e.to
    };
    e.Pos = Ut, e.prototype = {
        constructor: e, focus: function () {
            window.focus(), dt(this), Ft(this), ct(this)
            ...
            for (var t = this.state.keyMaps, r = 0; r < t.length; ++r) if (t[r] == e || "string" != typeof t[r] && t[r].name == e) return t.splice(r, 1), !0
        }, addOverlay: ot(null, function (t, r) {
            var n = t.token ? t : e.getMode(this.options, t);
            if (n.startState) throw new Error("Overlays may not be stateful.");
            this.state.overlays.push({mode: n, modeSpec: t, opaque: r && r.opaque}), this.state.modeGen++, at(this)
            ...
            "string" != typeof t && "number" != typeof t && (t = null == t ? this.options.smartIndent ? "smart" : "prev" : t ? "add" : "subtract"), Yt(this.doc, e) && ur(this, e, t, r)
        }), indentSelection: ot(null, function (e) {
            var t = this.doc.sel;
            if (Gt(t.from, t.to)) return ur(this, t.from.line, e);
            for (var r = t.to.line - (t.to.ch ? 0 : 1), n = t.from.line; r >= n; ++n) ur(this, n, e)
        }), getTokenAt: function (e, t) {
            var r = this.doc;
            e = Qt(r, e);
            for (var n = O(this, e.line, t), i = this.doc.mode, o = hn(r, e.line), l = new kr(o.text, this.options.tabSize); l.pos < e.ch && !l.eol();) {
                l.start = l.pos;
                var s = i.token(l, n)
            }
            ...
            e = Qt(this.doc, e);
            var t = Xr(this, hn(this.doc, e.line)), r = 0, n = (t.length - 1) / 2, i = e.ch;
            if (0 == i) return t[2];
            for (; ;) {
                var o = r + n >> 1;
                if ((o ? t[2 * o - 1] : 0) >= i) n = o; else {
            ...
            if (uo.hasOwnProperty(t)) {
                var r = uo[t], n = this.getModeAt(e);
                return n[t] && r[n[t]] || n.helperType && r[n.helperType] || r[n.name]
            }
        }, getStateAfter: function (e, t) {
            var r = this.doc;
            return e = Kt(r, null == e ? r.first + r.size - 1 : e), O(this, e + 1, t)
        }, cursorCoords: function (e, t) {
            var r, n = this.doc.sel;
            return r = null == e ? n.head : "object" == typeof e ? Qt(this.doc, e) : e ? n.from : n.to, Y(this, r, t || "page")
        }, charCoords: function (e, t) {
            return X(this, Qt(this.doc, e), t || "page")
        }, coordsChar: function (e, t) {
            return e = Q(this, e, t || "page"), J(this, e.left, e.top)
        }, lineAtHeight: function (e, t) {
            return e = Q(this, {top: e, left: 0}, t || "page").top, gn(this.doc, e + this.display.viewOffset)
        }, heightAtLine: function (e, t) {
            var r = !1, n = this.doc.first + this.doc.size - 1;
            e < this.doc.first ? e = this.doc.first : e > n && (e = n, r = !0);
            var i = hn(this.doc, e);
            return K(this, hn(this.doc, e), {top: 0, left: 0}, t || "page").top + (r ? i.height : 0)
            ...
            if ("number" == typeof e) {
                if (!Yt(this.doc, e)) return null;
                var t = e;
                if (e = hn(this.doc, e), !e) return null
            } else {
                var t = mn(e);
            ...
            var o = this.display;
            e = Y(this, Qt(this.doc, e));
            var l = e.bottom, s = e.left;
            if (t.style.position = "absolute", o.sizer.appendChild(t), "over" == n) l = e.top; else if ("above" == n || "near" == n) {
        ...
        }, triggerOnKeyDown: ot(null, At), execCommand: function (e) {
            return co[e](this)
        }, findPosH: function (e, t, r, n) {
            var i = 1;
            0 > t && (i = -1, t = -t);
            for (var o = 0, l = Qt(this.doc, e); t > o && (l = hr(this.doc, l, i, r, n), !l.hitSide); ++o) ;
            return l
        }, moveH: ot(null, function (e, t) {
            var r, n = this.doc.sel;
            r = n.shift || n.extend || Gt(n.from, n.to) ? hr(this.doc, n.head, e, t, this.options.rtlMoveVisually) : 0 > e ? n.from : n.to, Zt(this.doc, r, r, e)
        }), deleteH: ot(null, function (e, t) {
            var r = this.doc.sel;
            Gt(r.from, r.to) ? jt(this.doc, "", r.from, hr(this.doc, r.head, e, t, !1), "+delete") : jt(this.doc, "", r.from, r.to, "+delete"), this.curOp.userSelChange = !0
        }), findPosV: function (e, t, r, n) {
            var i = 1, o = n;
            0 > t && (i = -1, t = -t);
            for (var l = 0, s = Qt(this.doc, e); t > l; ++l) {
                var a = Y(this, s, "div");
                if (null == o ? o = a.left : a.left = o, s = fr(this, a, i, r), s.hitSide) break
            }
            return s
        }, moveV: ot(null, function (e, t) {
            var r = this.doc.sel, n = Y(this, r.head, "div");
            null != r.goalColumn && (n.left = r.goalColumn);
            var i = fr(this, n, e, t);
            "page" == t && ar(this, 0, X(this, i, "div").top - n.top), Zt(this.doc, i, i, e), r.goalColumn = n.left
            ...
            var e = this.display.scroller, t = Co;
            return {
                left: e.scrollLeft,
                top: e.scrollTop,
            ...
            var r = e;
            e && null == e.line || (this.curOp.scrollToPos = e ? Qt(this.doc, e) : this.doc.sel.head, this.curOp.scrollToPosMargin = t, r = Y(this, this.curOp.scrollToPos));
            ...
            G(this), sr(this, this.doc.scrollLeft, this.doc.scrollTop), at(this)
        }), swapDoc: ot(null, function (e) {
            var t = this.doc;
            return t.cm = null, cn(this, e), G(this), ft(this, !0), sr(this, e.scrollLeft, e.scrollTop), t
    ...
    mr("value", "", function (e, t) {
        ...
        r(e), G(e), at(e)
    }, !0), mr("electricChars", !0), mr("rtlMoveVisually", !Pi), mr("theme", "default", function (e) {
        s(e), a(e)
        ...
        return e
    }, a, !0), mr("showCursorWhenSelecting", !1, E, !0), mr("readOnly", !1, function (e, t) {
        "nocursor" == t ? (Dt(e), e.display.input.blur()) : t || ft(e, !0)
    ...
    e.defineMode = function (t, r) {
        ...
        if ("string" == typeof t && lo.hasOwnProperty(t)) t = lo[t]; else if (t && "string" == typeof t.name && lo.hasOwnProperty(t.name)) {
            var r = lo[t.name];
            t = Yn(r, t), t.name = r.name
        ...
        var r = e.resolveMode(r), n = oo[r.name];
    ...
    var co = e.commands = {
        selectAll: function (e) {
            ...
            var t = e.getCursor(!0), r = e.getCursor(!1), n = !Gt(t, r);
            ...
            var t = e.getCursor(), r = gi(e, t.line), n = e.getLineHandle(r.line), i = yn(n);
            if (i && 0 != i[0].level) e.extendSelection(r); else {
    ...
    ho.basic = {
    ...
    }, ho["default"] = Ii ? ho.macDefault : ho.pcDefault, ho.emacsy = {
        "Ctrl-F": "goCharRight",
        "Ctrl-B": "goCharLeft",
        "Ctrl-P": "goLineUp",
        "Ctrl-N": "goLineDown",
        ...
        if (t.form && (Wn(t.form, "submit", n), !r.leaveSubmitMethodAlone)) {
        ...
        return u.save = n, u.getTextArea = function () {
            ...
            n(), t.parentNode.removeChild(u.getWrapperElement()), t.style.display = "", t.form && (In(t.form, "submit", n), "function" == typeof t.form.submit && (t.form.submit = s))
        }, u
    }, kr.prototype = {
        eol: function () {
            ...
            return this.lastColumnPos < this.start && (this.lastColumnValue = qn(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue
    ...
    }, e.StringStream = kr, e.TextMarker = Cr, Un(Cr), Cr.prototype.clear = function () {
        if (!this.explicitlyCleared) {
            ...
            for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                var l = this.lines[o], s = Tr(l.markedSpans, this);
                null != s.to && (i = mn(l)), l.markedSpans = Er(l.markedSpans, s), null != s.from ? n = mn(l) : this.collapsed && !Pr(this.doc, l) && e && pn(l, tt(e.display))
            }
            if (e && this.collapsed && !e.options.lineWrapping) for (var o = 0; o < this.lines.length; ++o) {
                var a = Ir(e.doc, this.lines[o]), u = c(e.doc, a);
    ...
    }, Cr.prototype.find = function () {
        for (var e, t, r = 0; r < this.lines.length; ++r) {
            var n = this.lines[r], i = Tr(n.markedSpans, this);
            if (null != i.from || null != i.to) {
                var o = mn(n);
                null != i.from && (e = Ut(o, i.from)), null != i.to && (t = Ut(o, i.to))
            }
        }
        return "bookmark" == this.type ? e : e && {from: e, to: t}
    }, Cr.prototype.changed = function () {
        var e = this.find(), t = this.doc.cm;
        if (e && t) {
            var r = hn(this.doc, e.from.line);
            if (B(t, r), e.from.line >= t.display.showingFrom && e.from.line < t.display.showingTo) {
        ...
        if (this.lines.splice(Xn(this.lines, e), 1), !this.lines.length && this.doc.cm) {
            var t = this.doc.cm.curOp;
    ...
    var fo = e.LineWidget = function (e, t, r) {
        if (r) for (var n in r) r.hasOwnProperty(n) && (this[n] = r[n]);
        this.cm = e, this.node = t
    };
    Un(fo), fo.prototype.clear = jr(function () {
        var e = this.line.widgets, t = mn(this.line);
        if (null != t && e) {
    ...
    }), fo.prototype.changed = jr(function () {
        var e = this.height;
        this.height = null;
        var t = Ur(this) - e;
        if (t) {
    ...
    var po = e.Line = function (e, t, r) {
        this.text = e, $r(this, t), this.height = r ? r(this) : 1
    };
    Un(po);
    var mo = {}, go = /[\t\u0000-\u0019\u00ad\u200b\u2028\u2029\uFEFF]/g;
    sn.prototype = {
        ...
        chunkSize: function () {
                ...
                if (l >= e) {
                    if (o.insertInner(e, t, r), o.lines && o.lines.length > 50) {
                        for (; o.lines.length > 50;) {
                            var s = o.lines.splice(o.lines.length - 25, 25), a = new sn(s);
            ...
            if (!(this.children.length <= 10)) {
                var e = this;
                do {
                    var t = e.children.splice(e.children.length - 5, 5), r = new an(t);
                    if (e.parent) {
                        e.size -= r.size, e.height -= r.height;
                        var n = Xn(e.parent.children, e);
    ...
    var vo = 0, yo = e.Doc = function (e, t, r) {
        ...
        this.sel = {
            ...
            extend: !1,
            goalColumn: null
        }, this.id = ++vo, this.modeOption = t, "string" == typeof e && (e = Fo(e)), ln(this, {
            from: n,
            to: n,
            text: e
        }, null, {head: n, anchor: n})
    };
    yo.prototype = Yn(an.prototype, {
        constructor: yo, iter: function (e, t, r) {
            ...
            var t = Ut(this.first, 0), r = this.first + this.size - 1;
            Wt(this, {from: t, to: Ut(r, hn(this, r).text.length), text: Fo(e), origin: "setValue"}, {
                head: t,
                anchor: t
            }, !0)
        }, replaceRange: function (e, t, r, n) {
            t = Qt(this, t), r = r ? Qt(this, r) : t, jt(this, e, t, r, n)
        }, getRange: function (e, t, r) {
            var n = fn(this, Qt(this, e), Qt(this, t));
            return r === !1 ? n : n.join(r || "\n")
        }, getLine: function (e) {
            var t = this.getLineHandle(e);
            return t && t.text
        }, setLine: function (e, t) {
            Yt(this, e) && jt(this, t, Ut(e, 0), Qt(this, Ut(e)))
        }, removeLine: function (e) {
            e ? jt(this, "", Qt(this, Ut(e - 1)), Qt(this, Ut(e))) : jt(this, "", Ut(0, 0), Qt(this, Ut(1, 0)))
        }, getLineHandle: function (e) {
            return Yt(this, e) ? hn(this, e) : void 0
        }, getLineNumber: function (e) {
            return mn(e)
        }, getLineHandleVisualStart: function (e) {
            return "number" == typeof e && (e = hn(this, e)), Ir(this, e)
        }, lineCount: function () {
            return this.size
        }, firstLine: function () {
            return this.first
            ...
            var t, r = this.sel;
            return t = null == e || "head" == e ? r.head : "anchor" == e ? r.anchor : "end" == e || e === !1 ? r.to : r.from, Vt(t)
        }, somethingSelected: function () {
            return !Gt(this.sel.head, this.sel.anchor)
        }, setCursor: lt(function (e, t, r) {
            var n = Qt(this, "number" == typeof e ? Ut(e, t || 0) : e);
            r ? Zt(this, n) : er(this, n, n)
        }), setSelection: lt(function (e, t) {
            er(this, Qt(this, e), Qt(this, t || e))
        }), extendSelection: lt(function (e, t) {
            Zt(this, Qt(this, e), t && Qt(this, t))
        }), getSelection: function (e) {
            return this.getRange(this.sel.from, this.sel.to, e)
        }, replaceSelection: function (e, t, r) {
            Wt(this, {from: this.sel.from, to: this.sel.to, text: Fo(e), origin: r}, t || "around")
        }, undo: lt(function () {
            Pt(this, "undo")
        }), redo: lt(function () {
            Pt(this, "redo")
            ...
            return {done: Sn(this.history.done), undone: Sn(this.history.undone)}
            ...
            return Lr(this, Qt(this, e), Qt(this, t), r, "range")
        }, setBookmark: function (e, t) {
            var r = {replacedWith: t && (null == t.nodeType ? t.widget : t), insertLeft: t && t.insertLeft};
            return e = Qt(this, e), Lr(this, e, e, r, "bookmark")
        }, findMarksAt: function (e) {
            e = Qt(this, e);
            var t = [], r = hn(this, e.line).markedSpans;
            ...
            }), n.linked = [{doc: this, isParent: !0, sharedHist: e.sharedHist}], n
    ...
    for (var xo in yo.prototype) yo.prototype.hasOwnProperty(xo) && Xn(bo, xo) < 0 && (e.prototype[xo] = function (e) {
        return function () {
    ...
    Ci ? ai = function (e, t) {
    ...
    } : Fi && !/Version\/([6-9]|\d\d)\b/.test(navigator.userAgent) ? ai = function (e, t) {
        ...
        return /[~!#%&*)=+}\]|\"\.>,:;][({[<]|-[^\-?\.\u2010-\u201f\u2026]|\?[\w~`@#$%\^&*(_=+{[|><]|â€¦[\w~`@#$%\^&*(_=+{[><]/.test(e.slice(t - 1, t + 1))
    });
    var Ao, _o, Fo = 3 != "\n\nb".split(/\n/).length ? function (e) {
    ...
    e.splitLines = Fo;
    var Do = window.getSelection ? function (e) {
        try {
    ...
    e.keyNames = zo, function () {
        for (var e = 0; 10 > e; e++) zo[e + 48] = String(e);
    ...
    var Oo, Ho = function () {
        ...
        var t = "bbbbbbbbbtstwsbbbbbbbbbbbbbbssstwNN%%%NNNNNN,N,N1111111111NNNNNNNLLLLLLLLLLLLLLLLLLLLLLLLLLNNNNNNLLLLLLLLLLLLLLLLLLLLLLLLLLNNNNbbbbbbsbbbbbbbbbbbbbbbbbbbbbbbbbb,N%%%%NNNNLNNNNN%%11NLNNN1LNNNNNLLLLLLLLLLLLLLLLLLLLLLLNLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLNLLLLLLLL",
            ...
            n = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/, i = /[stwN]/, o = /[LRr]/, l = /[Lb1n]/, s = /[1n]/,
            a = "L";
        return function (t) {
            if (!n.test(t)) return !1;
            for (var r, u = t.length, c = [], h = 0; u > h; ++h) c.push(r = e(t.charCodeAt(h)));
            for (var h = 0, f = a; u > h; ++h) {
                var r = c[h];
                "m" == r ? c[h] = f : f = r
            }
            for (var h = 0, d = a; u > h; ++h) {
                var r = c[h];
                "1" == r && "r" == d ? c[h] = "n" : o.test(r) && (d = r, "r" == r && (c[h] = "R"))
            }
            for (var h = 1, f = c[0]; u - 1 > h; ++h) {
                var r = c[h];
                "+" == r && "1" == f && "1" == c[h + 1] ? c[h] = "1" : "," != r || f != c[h + 1] || "1" != f && "n" != f || (c[h] = f), f = r
            }
            for (var h = 0; u > h; ++h) {
                var r = c[h];
                if ("," == r) c[h] = "N"; else if ("%" == r) {
                    for (var p = h + 1; u > p && "%" == c[p]; ++p) ;
                    for (var m = h && "!" == c[h - 1] || u - 1 > p && "1" == c[p] ? "1" : "N", g = h; p > g; ++g) c[g] = m;
                    h = p - 1
                }
            }
            for (var h = 0, d = a; u > h; ++h) {
                var r = c[h];
                "L" == d && "1" == r ? c[h] = "L" : o.test(r) && (d = r)
            }
            for (var h = 0; u > h; ++h) if (i.test(c[h])) {
                for (var p = h + 1; u > p && i.test(c[p]); ++p) ;
                for (var v = "L" == (h ? c[h - 1] : a), y = "L" == (u - 1 > p ? c[p] : a), m = v || y ? "L" : "R", g = h; p > g; ++g) c[g] = m;
                h = p - 1
            }
            for (var b, x = [], h = 0; u > h;) if (l.test(c[h])) {
                var w = h;
                for (++h; u > h && l.test(c[h]); ++h) ;
                x.push({from: w, to: h, level: 0})
            } else {
                var k = h, C = x.length;
                for (++h; u > h && "L" != c[h]; ++h) ;
                for (var g = k; h > g;) if (s.test(c[g])) {
                    g > k && x.splice(C, 0, {from: k, to: g, level: 1});
                    var L = g;
                    for (++g; h > g && s.test(c[g]); ++g) ;
                    x.splice(C, 0, {from: L, to: g, level: 2}), k = g
                } else ++g;
            ...
            return 1 == x[0].level && (b = t.match(/^\s+/)) && (x[0].from = b[0].length, x.unshift({
                ...
                to: b[0].length,
                level: 0
            })), 1 == Kn(x).level && (b = t.match(/\s+$/)) && (Kn(x).to -= b[0].length, x.push({
                from: u - b[0].length,
                to: u,
                level: 0
            })), x[0].level != Kn(x).level && x.push({from: u, to: u, level: x[0].level}), x
        }
    }();
    ...
    function i(e) {
        return e.linkTitle = !1, e.em = !1, e.strong = !1, e.quote = !1, g || e.f != l || (e.f = c, e.block = o), null
    }

    function o(e, i) {
        if (i.list !== !1 && i.indentationDiff >= 0 ? (i.indentationDiff < 4 && (i.indentation -= i.indentationDiff), i.list = null) : i.list = !1, i.indentationDiff >= 4) return i.indentation -= 4, e.skipToEnd(), L;
        if (e.eatSpace()) return null;
        if ("#" === e.peek() || w && e.match(P)) i.header = !0; else if (e.eat(">")) i.indentation++, i.quote = !0; else {
            if ("[" === e.peek()) return r(e, i, f);
            if (e.match(H, !0)) return T;
            if (e.match(W, !0) || e.match(I, !0)) i.indentation += 4, i.list = !0; else if (t.fencedCodeBlocks && e.match(/^```([\w+#]*)/, !0)) return i.localMode = b(RegExp.$1), i.localMode && (i.localState = i.localMode.startState()), n(e, i, s), L
        }
    ...
    function l(e, t) {
        ...
        return g && "tag" === r && "openTag" !== t.htmlState.type && !t.htmlState.context && (t.f = c, t.block = o), t.md_inside && -1 != e.current().indexOf(">") && (t.f = c, t.block = o, t.htmlState.context = void 0), r
    }

    function s(e, t) {
        return e.sol() && e.match(/^```/, !0) ? (t.localMode = t.localState = null, t.f = c, t.block = o, L) : t.localMode ? t.localMode.token(e, t.localState) : (e.skipToEnd(), L)
    }

    function a(e) {
        var t = [];
        return e.strong ? t.push(e.em ? O : z) : e.em && t.push(N), e.linkText && t.push(F), e.code && t.push(L), e.header && t.push(C), e.quote && t.push(S), e.list !== !1 && t.push(M), t.length ? t.join(" ") : null
    }

    function u(e, t) {
        return e.match(R, !0) ? a(t) : void 0
    }
    ...
    function c(e, i) {
        ...
        var s = e.next();
        if ("\\" === s) return e.next(), a(i);
        if (i.linkTitle) {
            i.linkTitle = !1;
            var u = s;
            "(" === s && (u = ")"), u = (u + "").replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1");
            var c = "^\\s*(?:[^" + u + "\\\\]+|\\\\\\\\|\\\\.)" + u;
            if (e.match(new RegExp(c), !0)) return D
        }
        if ("`" === s) {
            var f = a(i), d = e.pos;
            e.eatWhile("`");
            var p = 1 + e.pos - d;
            return i.code ? p === x ? (i.code = !1, f) : a(i) : (x = p, i.code = !0, a(i))
        }
        if (i.code) return a(i);
        if ("!" === s && e.match(/\[[^\]]*\] ?(?:\(|\[)/, !1)) return e.match(/\[[^\]]*\]/), i.inline = i.f = h, E;
        if ("[" === s && e.match(/.*\](\(| ?\[)/, !1)) return i.linkText = !0, a(i);
        if ("]" === s && i.linkText) {
            var g = a(i);
            return i.linkText = !1, i.inline = i.f = h, g
        }
        if ("<" === s && e.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !0)) return r(e, i, m(A, ">"));
        if ("<" === s && e.match(/^[^> \\]+@(?:[^\\>]|\\.)+>/, !0)) return r(e, i, m(_, ">"));
        if ("<" === s && e.match(/^\w/, !1)) {
        ...
        if ("<" === s && e.match(/^\/\w*?>/)) return i.md_inside = !1, "tag";
        var y = !1;
        if (!t.underscoresBreakWords && "_" === s && "_" !== e.peek() && e.match(/(\w)/, !1)) {
            var b = e.pos - 2;
            if (b >= 0) {
                var w = e.string.charAt(b);
                "_" !== w && w.match(/(\w)/, !1) && (y = !0)
            }
        }
        var f = a(i);
        if ("*" === s || "_" === s && !y) {
            if (i.strong === s && e.eat(s)) return i.strong = !1, f;
            if (!i.strong && e.eat(s)) return i.strong = s, a(i);
            if (i.em === s) return i.em = !1, f;
            if (!i.em) return i.em = s, a(i)
        } else if (" " === s && (e.eat("*") || e.eat("_"))) {
            if (" " === e.peek()) return a(i);
            e.backUp(1)
        }
        return a(i)
    }
    ...
    function h(e, t) {
        if (e.eatSpace()) return null;
        var n = e.next();
        return "(" === n || "[" === n ? r(e, t, m(D, "(" === n ? ")" : "]")) : "error"
    }

    function f(e, t) {
        return e.match(/^[^\]]*\]:/, !0) ? (t.f = d, F) : r(e, t, c)
    }

    function d(e, t) {
        return e.eatSpace() ? null : (e.match(/^[^\s]+/, !0), void 0 === e.peek() ? t.linkTitle = !0 : e.match(/^(?:\s+(?:"(?:[^"\\]|\\\\|\\.)+"|'(?:[^'\\]|\\\\|\\.)+'|\((?:[^)\\]|\\\\|\\.)+\)))?/, !0), t.f = t.inline = c, D)
    }
    ...
    function m(e, t, r) {
        return r = r || c, function (n, i) {
            return n.match(p(t)), i.inline = i.f = r, e
        }
    }

    var g = CodeMirror.mimeModes.hasOwnProperty("text/html"), v = CodeMirror.getMode(e, g ? "text/html" : "text/plain"),
        y = {
            html: "htmlmixed",
            js: "javascript",
            ...
            var t, r, n = {}, i = {}, o = [];
            for (var l in CodeMirror.modes) CodeMirror.modes.propertyIsEnumerable(l) && o.push(l);
            for (t = 0; t < o.length; t++) n[o[t]] = o[t];
            var s = [];
            for (var l in CodeMirror.mimeModes) CodeMirror.mimeModes.propertyIsEnumerable(l) && s.push({
                mime: l,
                mode: CodeMirror.mimeModes[l]
            });
            for (t = 0; t < s.length; t++) r = s[t].mime, i[r] = s[t].mime;
            for (var a in y) (y[a] in n || y[a] in i) && (n[a] = y[a]);
            return function (t) {
    ...
    var x = 0, w = !1, k = !1, C = "header", L = "comment", S = "quote", M = "string", T = "hr", E = "tag", A = "link",
        _ = "link", F = "link", D = "string", N = "em", z = "strong", O = "emstrong", H = /^([*\-=_])(?:\s*\1){2,}\s*$/,
        W = /^[*\-+]\s+/, I = /^[0-9]+\.\s+/, P = /^(?:\={1,}|-{1,})$/, R = /^[^!\[\]*_\\<>` "'(]+/, B = [];
    return {
        startState: function () {
            return w = !1, k = !1, {
                f: o,
            ...
            if (e.sol()) {
                if (e.match(/^\s*$/, !0)) return w = !1, i(t);
                k && (w = !0, k = !1), k = !0, t.header = !1, t.code = !1, t.f = t.block;
            ...
            return t.f(e, t)
        }, blankLine: i, getType: a
    }
}, "xml"), function () {
    var e = this, t = e._, r = Array.prototype, n = Object.prototype, i = Function.prototype, o = r.push, l = r.slice,
        s = r.concat, a = n.toString, u = n.hasOwnProperty, c = Array.isArray, h = Object.keys, f = i.bind,
        d = function (e) {
            return e instanceof d ? e : this instanceof d ? void (this._wrapped = e) : new d(e)
        };
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = d), exports._ = d) : e._ = d, d.VERSION = "1.7.0";
    ...
    d.iteratee = function (e, t, r) {
        return null == e ? d.identity : d.isFunction(e) ? p(e, t, r) : d.isObject(e) ? d.matches(e) : d.property(e)
        ...
        if (i === +i) for (n = 0; i > n; n++) t(e[n], n, e); else {
            var o = d.keys(e);
            for (n = 0, i = o.length; i > n; n++) t(e[o[n]], o[n], e)
        }
        return e
    }, d.map = d.collect = function (e, t, r) {
        if (null == e) return [];
        t = d.iteratee(t, r);
        for (var n, i = e.length !== +e.length && d.keys(e), o = (i || e).length, l = Array(o), s = 0; o > s; s++) n = i ? i[s] : s, l[s] = t(e[n], n, e);
        return l
    };
    var m = "Reduce of empty array with no initial value";
    d.reduce = d.foldl = d.inject = function (e, t, r, n) {
        null == e && (e = []), t = p(t, n, 4);
        var i, o = e.length !== +e.length && d.keys(e), l = (o || e).length, s = 0;
        if (arguments.length < 3) {
            if (!l) throw new TypeError(m);
            r = e[o ? o[s++] : s++]
        }
        for (; l > s; s++) i = o ? o[s] : s, r = t(r, e[i], i, e);
        return r
    }, d.reduceRight = d.foldr = function (e, t, r, n) {
        null == e && (e = []), t = p(t, n, 4);
        var i, o = e.length !== +e.length && d.keys(e), l = (o || e).length;
        if (arguments.length < 3) {
            if (!l) throw new TypeError(m);
            r = e[o ? o[--l] : --l]
        }
        for (; l--;) i = o ? o[l] : l, r = t(r, e[i], i, e);
        return r
    }, d.find = d.detect = function (e, t, r) {
        var n;
        return t = d.iteratee(t, r), d.some(e, function (e, r, i) {
            return t(e, r, i) ? (n = e, !0) : void 0
        }), n
    }, d.filter = d.select = function (e, t, r) {
        var n = [];
        return null == e ? n : (t = d.iteratee(t, r), d.each(e, function (e, r, i) {
            t(e, r, i) && n.push(e)
        }), n)
    }, d.reject = function (e, t, r) {
        return d.filter(e, d.negate(d.iteratee(t)), r)
    }, d.every = d.all = function (e, t, r) {
        if (null == e) return !0;
        t = d.iteratee(t, r);
        var n, i, o = e.length !== +e.length && d.keys(e), l = (o || e).length;
        for (n = 0; l > n; n++) if (i = o ? o[n] : n, !t(e[i], i, e)) return !1;
        return !0
    }, d.some = d.any = function (e, t, r) {
        if (null == e) return !1;
        t = d.iteratee(t, r);
        var n, i, o = e.length !== +e.length && d.keys(e), l = (o || e).length;
        for (n = 0; l > n; n++) if (i = o ? o[n] : n, t(e[i], i, e)) return !0;
        return !1
    }, d.contains = d.include = function (e, t) {
        return null == e ? !1 : (e.length !== +e.length && (e = d.values(e)), d.indexOf(e, t) >= 0)
    }, d.invoke = function (e, t) {
        var r = l.call(arguments, 2), n = d.isFunction(t);
        ...
        return d.filter(e, d.matches(t))
    }, d.findWhere = function (e, t) {
        return d.find(e, d.matches(t))
    }, d.max = function (e, t, r) {
        var n, i, o = -1 / 0, l = -1 / 0;
        if (null == t && null != e) {
            e = e.length === +e.length ? e : d.values(e);
            for (var s = 0, a = e.length; a > s; s++) n = e[s], n > o && (o = n)
        } else t = d.iteratee(t, r), d.each(e, function (e, r, n) {
            i = t(e, r, n), (i > l || i === -1 / 0 && o === -1 / 0) && (o = e, l = i)
        });
        return o
        ...
        if (null == t && null != e) {
            e = e.length === +e.length ? e : d.values(e);
            for (var s = 0, a = e.length; a > s; s++) n = e[s], o > n && (o = n)
        } else t = d.iteratee(t, r), d.each(e, function (e, r, n) {
            i = t(e, r, n), (l > i || 1 / 0 === i && 1 / 0 === o) && (o = e, l = i)
        });
        return o
    }, d.shuffle = function (e) {
        for (var t, r = e && e.length === +e.length ? e : d.values(e), n = r.length, i = Array(n), o = 0; n > o; o++) t = d.random(0, o), t !== o && (i[o] = i[t]), i[t] = r[o];
        return i
    }, d.sample = function (e, t, r) {
        return null == t || r ? (e.length !== +e.length && (e = d.values(e)), e[d.random(e.length - 1)]) : d.shuffle(e).slice(0, Math.max(0, t))
    }, d.sortBy = function (e, t, r) {
        return t = d.iteratee(t, r), d.pluck(d.map(e, function (e, r, n) {
    ...
    var g = function (e) {
        return function (t, r, n) {
            var i = {};
            return r = d.iteratee(r, n), d.each(t, function (n, o) {
                var l = r(n, o, t);
                e(i, n, l)
            }), i
        }
    };
    d.groupBy = g(function (e, t, r) {
        d.has(e, r) ? e[r].push(t) : e[r] = [t]
    }), d.indexBy = g(function (e, t, r) {
        e[r] = t
    }), d.countBy = g(function (e, t, r) {
        d.has(e, r) ? e[r]++ : e[r] = 1
    }), d.sortedIndex = function (e, t, r, n) {
        r = d.iteratee(r, n, 1);
        for (var i = r(t), o = 0, l = e.length; l > o;) {
            var s = o + l >>> 1;
            r(e[s]) < i ? o = s + 1 : l = s
        }
        return o
    }, d.toArray = function (e) {
        return e ? d.isArray(e) ? l.call(e) : e.length === +e.length ? d.map(e, d.identity) : d.values(e) : []
    }, d.size = function (e) {
        return null == e ? 0 : e.length === +e.length ? e.length : d.keys(e).length
    }, d.partition = function (e, t, r) {
        t = d.iteratee(t, r);
        var n = [], i = [];
        return d.each(e, function (e, r, o) {
            (t(e, r, o) ? n : i).push(e)
        }), [n, i]
    ...
    var v = function (e, t, r, n) {
        if (t && d.every(e, d.isArray)) return s.apply(n, e);
        for (var i = 0, l = e.length; l > i; i++) {
            var a = e[i];
            d.isArray(a) || d.isArguments(a) ? t ? o.apply(n, a) : v(a, t, r, n) : r || n.push(a)
        }
        return n
    };
    d.flatten = function (e, t) {
        ...
        return d.difference(e, l.call(arguments, 1))
    }, d.uniq = d.unique = function (e, t, r, n) {
        if (null == e) return [];
        d.isBoolean(t) || (n = r, r = t, t = !1), null != r && (r = d.iteratee(r, n));
        for (var i = [], o = [], l = 0, s = e.length; s > l; l++) {
            var a = e[l];
            if (t) l && o === a || i.push(a), o = a; else if (r) {
                var u = r(a, l, e);
                d.indexOf(o, u) < 0 && (o.push(u), i.push(a))
            } else d.indexOf(i, a) < 0 && i.push(a)
        }
        return i
    }, d.union = function () {
        ...
        for (var t = [], r = arguments.length, n = 0, i = e.length; i > n; n++) {
            var o = e[n];
            if (!d.contains(t, o)) {
                for (var l = 1; r > l && d.contains(arguments[l], o); l++) ;
                l === r && t.push(o)
            }
        }
        return t
    }, d.difference = function (e) {
        var t = v(l.call(arguments, 1), !0, !0, []);
        return d.filter(e, function (e) {
            return !d.contains(t, e)
        })
    }, d.zip = function (e) {
        if (null == e) return [];
        for (var t = d.max(arguments, "length").length, r = Array(t), n = 0; t > n; n++) r[n] = d.pluck(arguments, n);
        return r
        ...
        var n = 0, i = e.length;
        if (r) {
            if ("number" != typeof r) return n = d.sortedIndex(e, t), e[n] === t ? n : -1;
        ...
        for (var n = Math.max(Math.ceil((t - e) / r), 0), i = Array(n), o = 0; n > o; o++, e += r) i[o] = e;
        return i
    };
    var y = function () {
    };
    d.bind = function (e, t) {
        ...
        return r = l.call(arguments, 2), n = function () {
            ...
            var i = new y;
            y.prototype = null;
            var o = e.apply(i, r.concat(l.call(arguments)));
            return d.isObject(o) ? o : i
        }
    }, d.partial = function (e) {
        var t = l.call(arguments, 1);
        return function () {
            for (var r = 0, n = t.slice(), i = 0, o = n.length; o > i; i++) n[i] === d && (n[i] = arguments[r++]);
        ...
        for (t = 1; n > t; t++) r = arguments[t], e[r] = d.bind(e[r], e);
        return e
    }, d.memoize = function (e, t) {
        var r = function (n) {
            var i = r.cache, o = t ? t.apply(this, arguments) : n;
        ...
        return d.delay.apply(d, [e, 1].concat(l.call(arguments, 1)))
    }, d.throttle = function (e, t, r) {
        var n, i, o, l = null, s = 0;
        r || (r = {});
        var a = function () {
            s = r.leading === !1 ? 0 : d.now(), l = null, o = e.apply(n, i), l || (n = i = null)
        };
        return function () {
            var u = d.now();
            s || r.leading !== !1 || (s = u);
            var c = t - (u - s);
            return n = this, i = arguments, 0 >= c || c > t ? (clearTimeout(l), l = null, s = u, o = e.apply(n, i), l || (n = i = null)) : l || r.trailing === !1 || (l = setTimeout(a, c)), o
        }
    }, d.debounce = function (e, t, r) {
        var n, i, o, l, s, a = function () {
            var u = d.now() - l;
            t > u && u > 0 ? n = setTimeout(a, t - u) : (n = null, r || (s = e.apply(o, i), n || (o = i = null)))
        };
        return function () {
            o = this, i = arguments, l = d.now();
            var u = r && !n;
            return n || (n = setTimeout(a, t)), u && (s = e.apply(o, i), o = i = null), s
        }
    }, d.wrap = function (e, t) {
    ...
    }, d.once = d.partial(d.before, 2), d.keys = function (e) {
        ...
        for (var t = d.keys(e), r = t.length, n = Array(r), i = 0; r > i; i++) n[i] = e[t[i]];
        return n
    }, d.pairs = function (e) {
        for (var t = d.keys(e), r = t.length, n = Array(r), i = 0; r > i; i++) n[i] = [t[i], e[t[i]]];
        return n
    }, d.invert = function (e) {
        for (var t = {}, r = d.keys(e), n = 0, i = r.length; i > n; n++) t[e[r[n]]] = r[n];
        return t
        ...
        if (!d.isObject(e)) return e;
        for (var t, r, n = 1, i = arguments.length; i > n; n++) {
            t = arguments[n];
            for (r in t) u.call(t, r) && (e[r] = t[r])
        }
        return e
    }, d.pick = function (e, t, r) {
        var n, i = {};
        if (null == e) return i;
        if (d.isFunction(t)) {
            t = p(t, r);
            ...
            var a = s.apply([], l.call(arguments, 1));
            e = new Object(e);
            for (var u = 0, c = a.length; c > u; u++) n = a[u], n in e && (i[n] = e[n])
        }
        return i
    }, d.omit = function (e, t, r) {
        if (d.isFunction(t)) t = d.negate(t); else {
            var n = d.map(s.apply([], l.call(arguments, 1)), String);
            t = function (e, t) {
    ...
    var b = function (e, t, r, n) {
        ...
        for (var o = r.length; o--;) if (r[o] === e) return n[o] === t;
        var l = e.constructor, s = t.constructor;
        if (l !== s && "constructor" in e && "constructor" in t && !(d.isFunction(l) && l instanceof l && d.isFunction(s) && s instanceof s)) return !1;
        r.push(e), n.push(t);
        var u, c;
        if ("[object Array]" === i) {
            if (u = e.length, c = u === t.length) for (; u-- && (c = b(e[u], t[u], r, n));) ;
        } else {
            var h, f = d.keys(e);
            if (u = f.length, c = d.keys(t).length === u) for (; u-- && (h = f[u], c = d.has(t, h) && b(e[h], t[h], r, n));) ;
        }
    ...
    d.isEqual = function (e, t) {
        ...
        if (null == e) return !0;
        if (d.isArray(e) || d.isString(e) || d.isArguments(e)) return 0 === e.length;
        for (var t in e) if (d.has(e, t)) return !1;
        return !0
    ...
    }, d.each(["Arguments", "Function", "String", "Number", "Date", "RegExp"], function (e) {
        d["is" + e] = function (t) {
            return a.call(t) === "[object " + e + "]"
        }
    }), d.isArguments(arguments) || (d.isArguments = function (e) {
        return d.has(e, "callee")
    }), "function" != typeof /./ && (d.isFunction = function (e) {
    ...
    }, d.property = function (e) {
        return function (t) {
            return t[e]
        }
    }, d.matches = function (e) {
        var t = d.pairs(e), r = t.length;
        return function (e) {
            if (null == e) return !r;
            e = new Object(e);
            for (var n = 0; r > n; n++) {
    ...
    var x = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;"}, w = d.invert(x),
        k = function (e) {
            var t = function (t) {
                return e[t]
            }, r = "(?:" + d.keys(e).join("|") + ")", n = RegExp(r), i = RegExp(r, "g");
            return function (e) {
                return e = null == e ? "" : "" + e, n.test(e) ? e.replace(i, t) : e
            }
        };
    d.escape = k(x), d.unescape = k(w), d.result = function (e, t) {
        if (null == e) return void 0;
        var r = e[t];
        return d.isFunction(r) ? e[t]() : r
    };
    var C = 0;
    ...
    d.template = function (e, t, r) {
        ...
        var n = RegExp([(t.escape || L).source, (t.interpolate || L).source, (t.evaluate || L).source].join("|") + "|$", "g"),
            i = 0, o = "__p+='";
        e.replace(n, function (t, r, n, l, s) {
            return o += e.slice(i, s).replace(M, T), i = s + t.length, r ? o += "'+\n((__t=(" + r + "))==null?'':_.escape(__t))+\n'" : n ? o += "'+\n((__t=(" + n + "))==null?'':__t)+\n'" : l && (o += "';\n" + l + "\n__p+='"), t
    ...
    var E = function (e) {
        return this._chain ? d(e).chain() : e
    };
    d.mixin = function (e) {
        d.each(d.functions(e), function (t) {
            ...
            d.prototype[t] = function () {
                var e = [this._wrapped];
                return o.apply(e, arguments), E.call(this, r.apply(d, e))
            }
        })
        ...
        d.prototype[e] = function () {
            var r = this._wrapped;
            return t.apply(r, arguments), "shift" !== e && "splice" !== e || 0 !== r.length || delete r[0], E.call(this, r)
        }
    ...
    function e(e) {
        this.tokens = [], this.tokens.links = {}, this.options = e || u.defaults, this.rules = c.normal, this.options.gfm && (this.rules = this.options.tables ? c.tables : c.gfm)
    }
    ...
    function u(t, r, o) {
        if (o || "function" == typeof r) {
            o || (o = r, r = null), r = a({}, u.defaults, r || {});
            var l, s, c = r.highlight, h = 0;
            try {
                l = e.lex(t, r)
            } catch (f) {
                return o(f)
            ...
            var d = function () {
                ...
                return r.highlight = c, t ? o(t) : o(null, e)
            };
            if (!c || c.length < 3) return d();
            if (delete r.highlight, !s) return d();
            for (; h < l.length; h++) !function (e) {
                return "code" !== e.type ? --s || d() : c(e.text, e.lang, function (t, r) {
                    return null == r || r === e.text ? --s || d() : (e.text = r, e.escaped = !0, --s || d(), void 0)
                })
            }(l[h])
        } else try {
            return r && (r = a({}, u.defaults, r)), n.parse(e.lex(t, r), r)
        } catch (f) {
            if (f.message += "\nPlease report this to https://github.com/chjj/marked.", (r || u.defaults).silent) return "<p>An error occured:</p><pre>" + i(f.message + "", !0) + "</pre>";
            throw f
        }
    }
    ...
    c.bullet = /(?:[*+-]|\d+\.)/, c.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, c.item = l(c.item, "gm")(/bull/g, c.bullet)(), c.list = l(c.list)(/bull/g, c.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + c.def.source + ")")(), c.blockquote = l(c.blockquote)("def", c.def)(), c._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b", c.html = l(c.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, c._tag)(), c.paragraph = l(c.paragraph)("hr", c.hr)("heading", c.heading)("lheading", c.lheading)("blockquote", c.blockquote)("tag", "<" + c._tag)("def", c.def)(), c.normal = a({}, c), c.gfm = a({}, c.normal, {
        ...
        for (var n, i, o, l, s, a, u, h, f, e = e.replace(/^ +$/gm, ""); e;) if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), o[0].length > 1 && this.tokens.push({type: "space"})), o = this.rules.code.exec(e)) e = e.substring(o[0].length), o = o[0].replace(/^ {4}/gm, ""), this.tokens.push({
            type: "code",
            ...
            for (e = e.substring(o[0].length), a = {
                type: "table",
            ...
            for (h = 0; h < a.cells.length; h++) a.cells[h] = a.cells[h].split(/ *\| */);
            this.tokens.push(a)
            ...
            for (h = 0; h < a.cells.length; h++) a.cells[h] = a.cells[h].replace(/^ *\| *| *\| *$/g, "").split(/ *\| */);
            this.tokens.push(a)
    ...
    h._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/, h._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, h.link = l(h.link)("inside", h._inside)("href", h._href)(), h.reflink = l(h.reflink)("inside", h._inside)(), h.normal = a({}, h), h.pedantic = a({}, h.normal, {
        ...
        for (var t, r, n, o, l = ""; e;) if (o = this.rules.escape.exec(e)) e = e.substring(o[0].length), l += o[1]; else if (o = this.rules.autolink.exec(e)) e = e.substring(o[0].length), "@" === o[2] ? (r = ":" === o[1].charAt(6) ? this.mangle(o[1].substring(7)) : this.mangle(o[1]), n = this.mangle("mailto:") + r) : (r = i(o[1]), n = r), l += this.renderer.link(n, null, r); else if (this.inLink || !(o = this.rules.url.exec(e))) {
            if (o = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(o[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(o[0]) && (this.inLink = !1), e = e.substring(o[0].length), l += this.options.sanitize ? i(o[0]) : o[0]; else if (o = this.rules.link.exec(e)) e = e.substring(o[0].length), this.inLink = !0, l += this.outputLink(o, {
                href: o[2],
                title: o[3]
        ...
        switch (this.token.type) {
            ...
            case"list_start":
                for (var l = "", s = this.token.ordered; "list_end" !== this.next().type;) l += this.tok();
                return this.renderer.list(l, s);
        ...
        renderer: new r,
        xhtml: !1
    }, u.Parser = n, u.parser = n.parse, u.Renderer = r, u.Lexer = e, u.lexer = e.lex, u.InlineLexer = t, u.inlineLexer = t.output, u.parse = u, "object" == typeof exports ? module.exports = u : "function" == typeof define && define.amd ? define(function () {
        return u
    }) : this.marked = u
}.call(function () {
    ...
    function e(t) {
        ...
        return "exports" in r || "function" != typeof r.definition || (r.client = r.component = !0, r.definition.call(this, r.exports = {}, r), delete r.definition), r.exports
    }

    e.loader = "component", e.helper = {}, e.helper.semVerSort = function (e, t) {
        for (var r = e.version.split("."), n = t.version.split("."), i = 0; i < r.length; ++i) {
            var o = parseInt(r[i], 10), l = parseInt(n[i], 10);
            if (o !== l) return o > l ? 1 : -1;
            var s = r[i].substr(("" + o).length), a = n[i].substr(("" + l).length);
            if ("" === s && "" !== a) return 1;
            if ("" !== s && "" === a) return -1;
            if ("" !== s && "" !== a) return s > a ? 1 : -1
        }
        return 0
    }, e.latest = function (t, r) {
        function n(e) {
        ...
        var i = /(.*)~(.*)@v?(\d+\.\d+\.\d+[^\/]*)$/, o = /(.*)~(.*)/;
        o.test(t) || n(t);
        for (var l = Object.keys(e.modules), s = [], a = [], u = 0; u < l.length; u++) {
            var c = l[u];
            if (new RegExp(t + "@").test(c)) {
                var h = c.substr(t.length + 1), f = i.exec(c);
                null != f ? s.push({version: h, name: c}) : a.push({version: h, name: c})
            }
        }
        if (0 === s.concat(a).length && n(t), s.length > 0) {
            var d = s.sort(e.helper.semVerSort).pop().name;
            return r === !0 ? d : e(d)
        }
        var d = a.pop().name;
        return r === !0 ? d : e(d)
    }, e.modules = {}, e.register = function (t, r) {
        e.modules[t] = {definition: r}
    }, e.define = function (t, r) {
        e.modules[t] = {exports: r}
        ...
        t.exports = r, r.prototype.on = r.prototype.addEventListener = function (e, t) {
            ...
            for (var n, i = 0; i < r.length; i++) if (n = r[i], n === t || n.fn === t) {
                r.splice(i, 1);
                break
            }
            return this
    ...
    }), e.register("dropzone", function (t, r) {
        r.exports = e("dropzone/lib/dropzone.js")
    }), e.register("dropzone/lib/dropzone.js", function (t, r) {
        (function () {
            var t, n, i, o, l, s, a, u, c = {}.hasOwnProperty, h = function (e, t) {
                function r() {
                    this.constructor = e
                }
            ...
            n = "undefined" != typeof Emitter && null !== Emitter ? Emitter : e("component~emitter@1.1.2"), a = function () {
            }, t = function (e) {
                function t(e, n) {
                    var i, o, l;
                    ...
                    if (t.instances.push(this), this.element.dropzone = this, i = null != (l = t.optionsForElement(this.element)) ? l : {}, this.options = r({}, this.defaultOptions, i, null != n ? n : {}), this.options.forceFallback || !t.isBrowserSupported()) return this.options.fallback.call(this);
                ...
                return h(t, e), t.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached"], t.prototype.defaultOptions = {
                    ...
                    fallback: function () {
                        var e, r, n, i, o, l;
                        for (this.element.className = "" + this.element.className + " dz-browser-not-supported", l = this.element.getElementsByTagName("div"), i = 0, o = l.length; o > i; i++) e = l[i], /(^| )dz-message($| )/.test(e.className) && (r = e, e.className = "dz-message");
                        return r || (r = t.createElement('<div class="dz-message"><span></span></div>'), this.element.appendChild(r)), n = r.getElementsByTagName("span")[0], n && (n.textContent = this.options.dictFallbackMessage), this.element.appendChild(this.getFallbackForm())
                    },
                    resize: function (e) {
                        var t, r, n;
                        return t = {
                    ...
                    addedfile: function (e) {
                        var r, n, i, o, l, s, a, u, c, h, f, d, p;
                        if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                            for (e.previewElement = t.createElement(this.options.previewTemplate.trim()), e.previewTemplate = e.previewElement, this.previewsContainer.appendChild(e.previewElement), h = e.previewElement.querySelectorAll("[data-dz-name]"), o = 0, a = h.length; a > o; o++) r = h[o], r.textContent = e.name;
                            for (f = e.previewElement.querySelectorAll("[data-dz-size]"), l = 0, u = f.length; u > l; l++) r = f[l], r.innerHTML = this.filesize(e.size);
                            for (this.options.addRemoveLinks && (e._removeLink = t.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>"), e.previewElement.appendChild(e._removeLink)), n = function (r) {
                                return function (n) {
                                    return n.preventDefault(), n.stopPropagation(), e.status === t.UPLOADING ? t.confirm(r.options.dictCancelUploadConfirmation, function () {
                                        return r.removeFile(e)
                                    }) : r.options.dictRemoveFileConfirmation ? t.confirm(r.options.dictRemoveFileConfirmation, function () {
                                        return r.removeFile(e)
                                    }) : r.removeFile(e)
                                }
                            }(this), d = e.previewElement.querySelectorAll("[data-dz-remove]"), p = [], s = 0, c = d.length; c > s; s++) i = d[s], p.push(i.addEventListener("click", n));
                            return p
                        }
                    },
                    ...
                    thumbnail: function (e, t) {
                        var r, n, i, o, l;
                        if (e.previewElement) {
                            for (e.previewElement.classList.remove("dz-file-preview"), e.previewElement.classList.add("dz-image-preview"), o = e.previewElement.querySelectorAll("[data-dz-thumbnail]"), l = [], n = 0, i = o.length; i > n; n++) r = o[n], r.alt = e.name, l.push(r.src = t);
                            return l
                        }
                    },
                    error: function (e, t) {
                        var r, n, i, o, l;
                        if (e.previewElement) {
                            for (e.previewElement.classList.add("dz-error"), "String" != typeof t && t.error && (t = t.error), o = e.previewElement.querySelectorAll("[data-dz-errormessage]"), l = [], n = 0, i = o.length; i > n; n++) r = o[n], l.push(r.textContent = t);
                            return l
                        }
                    },
                    errormultiple: a,
                    ...
                    uploadprogress: function (e, t) {
                        var r, n, i, o, l;
                        if (e.previewElement) {
                            for (o = e.previewElement.querySelectorAll("[data-dz-uploadprogress]"), l = [], n = 0, i = o.length; i > n; n++) r = o[n], l.push("PROGRESS" === r.nodeName ? r.value = t : r.style.width = "" + t + "%");
                            return l
                        }
                    },
                    ...
                    var e, t, r, n, i, o, l;
                    for (n = arguments[0], r = 2 <= arguments.length ? f.call(arguments, 1) : [], o = 0, l = r.length; l > o; o++) {
                        t = r[o];
                    ...
                    var e, t, r, n, i;
                    for (n = this.files, i = [], t = 0, r = n.length; r > t; t++) e = n[t], e.accepted && i.push(e);
                    return i
                    ...
                    var t, r, n, i, o;
                    for (i = this.files, o = [], r = 0, n = i.length; n > r; r++) t = i[r], t.status === e && o.push(t);
                    return o
                    ...
                    var e, r, n, i, o;
                    for (i = this.files, o = [], r = 0, n = i.length; n > r; r++) e = i[r], (e.status === t.UPLOADING || e.status === t.QUEUED) && o.push(e);
                    return o
                    ...
                    for ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(t.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + "</span></div>")), this.clickableElements.length && (n = function (e) {
                        return function () {
                            return e.hiddenFileInput && document.body.removeChild(e.hiddenFileInput), e.hiddenFileInput = document.createElement("input"), e.hiddenFileInput.setAttribute("type", "file"), (null == e.options.maxFiles || e.options.maxFiles > 1) && e.hiddenFileInput.setAttribute("multiple", "multiple"), e.hiddenFileInput.className = "dz-hidden-input", null != e.options.acceptedFiles && e.hiddenFileInput.setAttribute("accept", e.options.acceptedFiles), null != e.options.capture && e.hiddenFileInput.setAttribute("capture", e.options.capture), e.hiddenFileInput.style.visibility = "hidden", e.hiddenFileInput.style.position = "absolute", e.hiddenFileInput.style.top = "0", e.hiddenFileInput.style.left = "0", e.hiddenFileInput.style.height = "0", e.hiddenFileInput.style.width = "0", document.body.appendChild(e.hiddenFileInput), e.hiddenFileInput.addEventListener("change", function () {
                                var t, r, i, o;
                                if (r = e.hiddenFileInput.files, r.length) for (i = 0, o = r.length; o > i; i++) t = r[i], e.addFile(t);
                                return n()
                            })
                        }
                    }(this))(), this.URL = null != (l = window.URL) ? l : window.webkitURL, s = this.events, i = 0, o = s.length; o > i; i++) e = s[i], this.on(e, this.options[e]);
                    return this.on("uploadprogress", function (e) {
                        ...
                        return function (r) {
                            return e.listeners.push({
                                element: r, events: {
                                    click: function (n) {
                                        return r !== e.element || n.target === e.element || t.elementInside(n.target, e.element.querySelector(".dz-message")) ? e.hiddenFileInput.click() : void 0
                                    }
                                }
                            })
                        }
                    ...
                    var e, t, r, n, i, o, l, s;
                    if (n = 0, r = 0, e = this.getActiveFiles(), e.length) {
                        for (s = this.getActiveFiles(), o = 0, l = s.length; l > o; o++) t = s[o], n += t.upload.bytesSent, r += t.upload.total;
                        i = 100 * n / r
                    } else i = 100;
                    return this.emit("totaluploadprogress", i, r, n)
                }, t.prototype._getParamName = function (e) {
                    return "function" == typeof this.options.paramName ? this.options.paramName(e) : "" + this.options.paramName + (this.options.uploadMultiple ? "[" + e + "]" : "")
                }, t.prototype.getFallbackForm = function () {
                    var e, r, n, i;
                    return (e = this.getExistingFallback()) ? e : (n = '<div class="dz-fallback">', this.options.dictFallbackText && (n += "<p>" + this.options.dictFallbackText + "</p>"), n += '<input type="file" name="' + this._getParamName(0) + '" ' + (this.options.uploadMultiple ? 'multiple="multiple"' : void 0) + ' /><input type="submit" value="Upload!"></div>', r = t.createElement(n), "FORM" !== this.element.tagName ? (i = t.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>'), i.appendChild(r)) : (this.element.setAttribute("enctype", "multipart/form-data"), this.element.setAttribute("method", this.options.method)), null != i ? i : r)
                }, t.prototype.getExistingFallback = function () {
                    var e, t, r, n, i, o;
                    for (t = function (e) {
                        var t, r, n;
                        for (r = 0, n = e.length; n > r; r++) if (t = e[r], /(^| )fallback($| )/.test(t.className)) return t
                    }, o = ["div", "form"], n = 0, i = o.length; i > n; n++) if (r = o[n], e = t(this.element.getElementsByTagName(r))) return e
                    ...
                    }), this.removeEventListeners(), n = this.files, i = [], t = 0, r = n.length; r > t; t++) e = n[t], i.push(this.cancelUpload(e));
                    return i
                    ...
                    var t, r;
                    e.dataTransfer && (this.emit("drop", e), t = e.dataTransfer.files, t.length && (r = e.dataTransfer.items, r && r.length && null != r[0].webkitGetAsEntry ? this._addFilesFromItems(r) : this.handleFiles(t)))
                }, t.prototype.paste = function (e) {
                    var t, r;
                    return null != (null != e && null != (r = e.clipboardData) ? r.items : void 0) ? (this.emit("paste", e), t = e.clipboardData.items, t.length ? this._addFilesFromItems(t) : void 0) : void 0
                }, t.prototype.handleFiles = function (e) {
                    var t, r, n, i;
                    for (i = [], r = 0, n = e.length; n > r; r++) t = e[r], i.push(this.addFile(t));
                    return i
                }, t.prototype._addFilesFromItems = function (e) {
                    var t, r, n, i, o;
                    for (o = [], n = 0, i = e.length; i > n; n++) r = e[n], o.push(null != r.webkitGetAsEntry && (t = r.webkitGetAsEntry()) ? t.isFile ? this.addFile(r.getAsFile()) : t.isDirectory ? this._addFilesFromDirectory(t, t.name) : void 0 : null != r.getAsFile ? null == r.kind || "file" === r.kind ? this.addFile(r.getAsFile()) : void 0 : void 0);
                    return o
                }, t.prototype._addFilesFromDirectory = function (e, t) {
                    var r, n;
                    return r = e.createReader(), n = function (e) {
                        return function (r) {
                            var n, i, o;
                            for (i = 0, o = r.length; o > i; i++) n = r[i], n.isFile ? n.file(function (r) {
                                return e.options.ignoreHiddenFiles && "." === r.name.substring(0, 1) ? void 0 : (r.fullPath = "" + t + "/" + r.name, e.addFile(r))
                            }) : n.isDirectory && e._addFilesFromDirectory(n, "" + t + "/" + n.name)
                        }
                    }(this), r.readEntries(n, function (e) {
                        return "undefined" != typeof console && null !== console && "function" == typeof console.log ? console.log(e) : void 0
                    })
                }, t.prototype.accept = function (e, r) {
                    return e.size > 1024 * this.options.maxFilesize * 1024 ? r(this.options.dictFileTooBig.replace("{{filesize}}", Math.round(e.size / 1024 / 10.24) / 100).replace("{{maxFilesize}}", this.options.maxFilesize)) : t.isValidFile(e, this.options.acceptedFiles) ? null != this.options.maxFiles && this.getAcceptedFiles().length >= this.options.maxFiles ? (r(this.options.dictMaxFilesExceeded.replace("{{maxFiles}}", this.options.maxFiles)), this.emit("maxfilesexceeded", e)) : this.options.accept.call(this, e, r) : r(this.options.dictInvalidFileType)
                    ...
                    return e.upload = {
                        ...
                        return function (r) {
                            return r ? (e.accepted = !1, t._errorProcessing([e], r)) : (e.accepted = !0, t.options.autoQueue && t.enqueueFile(e)), t._updateMaxFilesReachedClass()
                        }
                    }(this))
                }, t.prototype.enqueueFiles = function (e) {
                    var t, r, n;
                    for (r = 0, n = e.length; n > r; r++) t = e[r], this.enqueueFile(t);
                    return null
                    ...
                    return e.status === t.UPLOADING && this.cancelUpload(e), this.files = u(this.files, e), this.emit("removedfile", e), 0 === this.files.length ? this.emit("reset") : void 0
                }, t.prototype.removeAllFiles = function (e) {
                    var r, n, i, o;
                    for (null == e && (e = !1), o = this.files.slice(), n = 0, i = o.length; i > n; n++) r = o[n], (r.status !== t.UPLOADING || e) && this.removeFile(r);
                    return null
                }, t.prototype.createThumbnail = function (e, t) {
                    var r;
                    return r = new FileReader, r.onload = function (n) {
                        return function () {
                            var i;
                            return "image/svg+xml" === e.type ? (n.emit("thumbnail", e, r.result), void (null != t && t())) : (i = document.createElement("img"), i.onload = function () {
                                var r, o, l, a, u, c, h, f;
                                return e.width = i.width, e.height = i.height, l = n.options.resize.call(n, e), null == l.trgWidth && (l.trgWidth = l.optWidth), null == l.trgHeight && (l.trgHeight = l.optHeight), r = document.createElement("canvas"), o = r.getContext("2d"), r.width = l.trgWidth, r.height = l.trgHeight, s(o, i, null != (u = l.srcX) ? u : 0, null != (c = l.srcY) ? c : 0, l.srcWidth, l.srcHeight, null != (h = l.trgX) ? h : 0, null != (f = l.trgY) ? f : 0, l.trgWidth, l.trgHeight), a = r.toDataURL("image/png"), n.emit("thumbnail", e, a), null != t ? t() : void 0
                            }, i.src = r.result)
                        }
                    }(this), r.readAsDataURL(e)
                }, t.prototype.processQueue = function () {
                    var e, t, r, n;
                    if (t = this.options.parallelUploads, r = this.getUploadingFiles().length, e = r, !(r >= t) && (n = this.getQueuedFiles(), n.length > 0)) {
                        if (this.options.uploadMultiple) return this.processFiles(n.slice(0, t - r));
                        for (; t > e;) {
                            if (!n.length) return;
                    ...
                    var r, n, i;
                    for (n = 0, i = e.length; i > n; n++) r = e[n], r.processing = !0, r.status = t.UPLOADING, this.emit("processing", r);
                    return this.options.uploadMultiple && this.emit("processingmultiple", e), this.uploadFiles(e)
                }, t.prototype._getFilesWithXhr = function (e) {
                    var t, r;
                    return r = function () {
                        var r, n, i, o;
                        for (i = this.files, o = [], r = 0, n = i.length; n > r; r++) t = i[r], t.xhr === e && o.push(t);
                        return o
                    }.call(this)
                }, t.prototype.cancelUpload = function (e) {
                    var r, n, i, o, l, s, a;
                    if (e.status === t.UPLOADING) {
                        for (n = this._getFilesWithXhr(e.xhr), i = 0, l = n.length; l > i; i++) r = n[i], r.status = t.CANCELED;
                        for (e.xhr.abort(), o = 0, s = n.length; s > o; o++) r = n[o], this.emit("canceled", r);
                        this.options.uploadMultiple && this.emit("canceledmultiple", n)
                    } else ((a = e.status) === t.ADDED || a === t.QUEUED) && (e.status = t.CANCELED, this.emit("canceled", e), this.options.uploadMultiple && this.emit("canceledmultiple", [e]));
                    ...
                    var n, i, o, l, s, a, u, c, h, f, d, p, m, g, v, y, b, x, w, k, C, L, S, M, T, E, A, _, F, D, N, z;
                    for (b = new XMLHttpRequest, x = 0, L = e.length; L > x; x++) n = e[x], n.xhr = b;
                    b.open(this.options.method, this.options.url, !0), b.withCredentials = !!this.options.withCredentials, g = null, o = function (t) {
                        return function () {
                            var r, i, o;
                            for (o = [], r = 0, i = e.length; i > r; r++) n = e[r], o.push(t._errorProcessing(e, g || t.options.dictResponseError.replace("{{statusCode}}", b.status), b));
                            return o
                        }
                    }(this), v = function (t) {
                        return function (r) {
                            var i, o, l, s, a, u, c, h, f;
                            if (null != r) for (o = 100 * r.loaded / r.total, l = 0, u = e.length; u > l; l++) n = e[l], n.upload = {
                                progress: o,
                                total: r.total,
                                bytesSent: r.loaded
                            }; else {
                                for (i = !0, o = 100, s = 0, c = e.length; c > s; s++) n = e[s], (100 !== n.upload.progress || n.upload.bytesSent !== n.upload.total) && (i = !1), n.upload.progress = o, n.upload.bytesSent = n.upload.total;
                                if (i) return
                            }
                            for (f = [], a = 0, h = e.length; h > a; a++) n = e[a], f.push(t.emit("uploadprogress", n, o, n.upload.bytesSent));
                            return f
                        }
                    }(this), b.onload = function (r) {
                        return function (n) {
                            var i;
                            if (e[0].status !== t.CANCELED && 4 === b.readyState) {
                                if (g = b.responseText, b.getResponseHeader("content-type") && ~b.getResponseHeader("content-type").indexOf("application/json")) try {
                                    ...
                                    n = l, g = "Invalid JSON response from server."
                                }
                                return v(), 200 <= (i = b.status) && 300 > i ? r._finished(e, g, n) : o()
                            }
                        }
                    }(this), b.onerror = function () {
                        return function () {
                            return e[0].status !== t.CANCELED ? o() : void 0
                        }
                    }(this), m = null != (A = b.upload) ? A : b, m.onprogress = v, a = {
                        Accept: "application/json",
                        "Cache-Control": "no-cache",
                        "X-Requested-With": "XMLHttpRequest"
                    }, this.options.headers && r(a, this.options.headers);
                    for (l in a) s = a[l], b.setRequestHeader(l, s);
                    if (i = new FormData, this.options.params) {
                        _ = this.options.params;
                        for (d in _) y = _[d], i.append(d, y)
                    }
                    for (w = 0, S = e.length; S > w; w++) n = e[w], this.emit("sending", n, b, i);
                    if (this.options.uploadMultiple && this.emit("sendingmultiple", e, b, i), "FORM" === this.element.tagName) for (F = this.element.querySelectorAll("input, textarea, select, button"), k = 0, M = F.length; M > k; k++) if (c = F[k], h = c.getAttribute("name"), f = c.getAttribute("type"), "SELECT" === c.tagName && c.hasAttribute("multiple")) for (D = c.options, C = 0, T = D.length; T > C; C++) p = D[C], p.selected && i.append(h, p.value); else (!f || "checkbox" !== (N = f.toLowerCase()) && "radio" !== N || c.checked) && i.append(h, c.value);
                    for (u = E = 0, z = e.length - 1; z >= 0 ? z >= E : E >= z; u = z >= 0 ? ++E : --E) i.append(this._getParamName(u), e[u], e[u].name);
                    return b.send(i)
                }, t.prototype._finished = function (e, r, n) {
                    var i, o, l;
                    for (o = 0, l = e.length; l > o; o++) i = e[o], i.status = t.SUCCESS, this.emit("success", i, r, n), this.emit("complete", i);
                    return this.options.uploadMultiple && (this.emit("successmultiple", e, r, n), this.emit("completemultiple", e)), this.options.autoProcessQueue ? this.processQueue() : void 0
                }, t.prototype._errorProcessing = function (e, r, n) {
                    var i, o, l;
                    for (o = 0, l = e.length; l > o; o++) i = e[o], i.status = t.ERROR, this.emit("error", i, r, n), this.emit("complete", i);
                    return this.options.uploadMultiple && (this.emit("errormultiple", e, r, n), this.emit("completemultiple", e)), this.options.autoProcessQueue ? this.processQueue() : void 0
                }, t
            }(n), t.version = "3.11.1", t.options = {}, t.optionsForElement = function (e) {
                ...
                for (document.querySelectorAll ? n = document.querySelectorAll(".dropzone") : (n = [], e = function (e) {
                    var t, r, i, o;
                    for (o = [], r = 0, i = e.length; i > r; r++) t = e[r], o.push(/(^| )dropzone($| )/.test(t.className) ? n.push(t) : void 0);
                    return o
                }, e(document.getElementsByTagName("div")), e(document.getElementsByTagName("form"))), l = [], i = 0, o = n.length; o > i; i++) r = n[i], l.push(t.optionsForElement(r) !== !1 ? new t(r) : void 0);
                return l
            }, t.blacklistedBrowsers = [/opera.*Macintosh.*version\/12/i], t.isBrowserSupported = function () {
                var e, r, n, i, o;
                if (e = !0, window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) if ("classList" in document.createElement("a")) for (o = t.blacklistedBrowsers, n = 0, i = o.length; i > n; n++) r = o[n], r.test(navigator.userAgent) && (e = !1); else e = !1; else e = !1;
                return e
            }, u = function (e, t) {
                var r, n, i, o;
                for (o = [], n = 0, i = e.length; i > n; n++) r = e[n], r !== t && o.push(r);
                return o
            }, i = function (e) {
                ...
                if (e instanceof Array) {
                    i = [];
                    try {
                        for (o = 0, s = e.length; s > o; o++) n = e[o], i.push(this.getElement(n, t))
                    } catch (c) {
                        r = c, i = null
                    }
                } else if ("string" == typeof e) for (i = [], u = document.querySelectorAll(e), l = 0, a = u.length; a > l; l++) n = u[l], i.push(n); else null != e.nodeType && (i = [e]);
                ...
                return i
            }, t.confirm = function (e, t, r) {
                return window.confirm(e) ? t() : null != r ? r() : void 0
            }, t.isValidFile = function (e, t) {
                var r, n, i, o, l;
                if (!t) return !0;
                for (t = t.split(","), n = e.type, r = n.replace(/\/.*$/, ""), o = 0, l = t.length; l > o; o++) if (i = t[o], i = i.trim(), "." === i.charAt(0)) {
            ...
            }), "undefined" != typeof r && null !== r ? r.exports = t : window.Dropzone = t, t.ADDED = "added", t.QUEUED = "queued", t.ACCEPTED = t.QUEUED, t.UPLOADING = "uploading", t.PROCESSING = t.UPLOADING, t.CANCELED = "canceled", t.ERROR = "error", t.SUCCESS = "success", l = function (e) {
                var t, r, n, i, o, l, s, a, u, c;
                for (s = e.naturalWidth, l = e.naturalHeight, r = document.createElement("canvas"), r.width = 1, r.height = l, n = r.getContext("2d"), n.drawImage(e, 0, 0), i = n.getImageData(0, 0, 1, l).data, c = 0, o = l, a = l; a > c;) t = i[4 * (a - 1) + 3], 0 === t ? o = a : c = a, a = o + c >> 1;
                return u = a / l, 0 === u ? 1 : u
            }, s = function (e, t, r, n, i, o, s, a, u, c) {
                var h;
                return h = l(t), e.drawImage(t, r, n, i, o, s, a, u, c / h)
            }, o = function (e, t) {
                var r, n, i, o, l, s, a, u, c;
                if (i = !1, c = !0, n = e.document, u = n.documentElement, r = n.addEventListener ? "addEventListener" : "attachEvent", a = n.addEventListener ? "removeEventListener" : "detachEvent", s = n.addEventListener ? "" : "on", o = function (r) {
                    return "readystatechange" !== r.type || "complete" === n.readyState ? (("load" === r.type ? e : n)[a](s + r.type, o, !1), !i && (i = !0) ? t.call(e, r.type || r) : void 0) : void 0
                }, l = function () {
                    var e;
                    try {
                        u.doScroll("left")
                    } catch (t) {
                        return e = t, void setTimeout(l, 50)
                    }
                    return o("poll")
                    ...
                    return n[r](s + "DOMContentLoaded", o, !1), n[r](s + "readystatechange", o, !1), e[r](s + "load", o, !1)
                }
            }, t._autoDiscoverFunction = function () {
                return t.autoDiscover ? t.discover() : void 0
            }, o(window, t._autoDiscoverFunction)
        }).call(this)
    }), "object" == typeof exports ? module.exports = e("dropzone") : "function" == typeof define && define.amd ? define("Dropzone", [], function () {
        return e("dropzone")
    }) : (this || window).Dropzone = e("dropzone")
}();
var MdEditor, __bind = function (e, t) {
    return function () {
        return e.apply(t, arguments)
    }
};
MdEditor = function () {
    function t(e, t) {
        return this.save = __bind(this.save, this), this.fullscreen = __bind(this.fullscreen, this), this.image = __bind(this.image, this), this.link = __bind(this.link, this), this.code = __bind(this.code, this), this.italic = __bind(this.italic, this), this.bold = __bind(this.bold, this), this.textarea = $(e), 0 === this.textarea.length ? console.log("Aucun élément ne correspond à ce selecteuir") : (this.options = {
            ...
            uploader: !1,
            uploaderData: {}
        }, this.markdownSections = [], this.previewSections = [], this.lastMardownScrollTop = null, this.lastPreviewScrollTop = null, this.scrolling = !1, this.isMarkdownMoving = !1, this.isPreviewMoving = !1, void 0 !== t && $.extend(this.options, t), this.canExit = !0, this.element = $('<div class="mdeditor">\n  <div class="mdeditor_toolbar"></div>\n  <div class="mdeditor_body">\n    <section class="mdeditor_markdown"><div class="mdeditor_scroll mdeditor_markdown_scroll"><header>Markdown</header></div></section>\n    <section class="mdeditor_preview"><div class="mdeditor_scroll mdeditor_preview_scroll"><header>Preview</header><div class="mdeditor_render"></div></div></section>\n  </div>\n  <div class="mdeditor_modal"><div class="mdeditor_drop"></div></div>\n</div>'), this.markdownScroll = $(".mdeditor_markdown_scroll", this.element), this.previewScroll = $(".mdeditor_preview_scroll", this.element), this.preview = $(".mdeditor_render", this.element), this.toolbar = $(".mdeditor_toolbar", this.element), this.form = this.textarea.parents("form"), this.textarea.after(this.element), this.options.preview || this.element.addClass("has-no-preview"), $(".mdeditor_markdown .mdeditor_scroll", this.element).append(this.textarea), this.editor = CodeMirror.fromTextArea(this.textarea[0], {
            mode: "markdown",
            tabMode: "indent",
            theme: "neo",
            lineWrapping: !0,
            viewportMargin: 1 / 0
        }), this.updatePreview(), this._buildToolbar(), this._buildDropzone(), this._bindEvents(), void 0)
    }

    return t.prototype.updatePreview = function () {
        var e;
        return e = this.editor.getValue(), this.textarea.val(this.editor.getValue()), this.preview.is(":visible") ? (this.preview.html(marked(e), {breaks: !0}), this._setSections()) : void 0
    }, t.prototype.flash = function (e) {
        return alert(e)
    }, t.prototype.bold = function (e) {
        return void 0 !== e && e.preventDefault(), this.editor.doc.replaceSelection("**" + this.editor.doc.getSelection("around") + "**"), this.editor.focus()
    }, t.prototype.italic = function (e) {
        return void 0 !== e && e.preventDefault(), this.editor.doc.replaceSelection("*" + this.editor.doc.getSelection("around") + "*"), this.editor.focus()
    }, t.prototype.code = function (e) {
        return void 0 !== e && e.preventDefault(), this.editor.doc.replaceSelection("```\n" + this.editor.doc.getSelection("around") + "\n```"), this.editor.focus()
    }, t.prototype.link = function (e) {
        var t;
        return void 0 !== e && e.preventDefault(), this.editor.doc.replaceSelection("[" + this.editor.doc.getSelection("end") + "]()"), t = this.editor.doc.getCursor(), this.editor.doc.setCursor({
            line: t.line,
            ch: t.ch - 1
        }), this.editor.focus()
    }, t.prototype.image = function (e) {
        return void 0 !== e && e.preventDefault(), $(".mdeditor_modal", this.element).toggle()
    }, t.prototype.fullscreen = function (e) {
        return void 0 !== e && e.preventDefault(), this.element.toggleClass("is-fullscreen"), this.editor.refresh()
    }, t.prototype.save = function (e) {
        return void 0 !== e && e.preventDefault, canExit ? !0 : $.ajax({
            dataType: "json",
            ...
            return function () {
                return e.canExit = !0, e.flash(e.options.labelSuccess)
            }
        }(this)).fail(function (e) {
            return function (t) {
                return e.flash(t.responseText)
            }
        }(this))
    }, t.prototype._bindEvents = function () {
        return this.editor.on("change", function (e) {
            return function () {
                return e.cenExit = !1, e.updatePreview()
            }
        }(this)), this.form.submit(function () {
            var e;
            return e = !0, !0
        }), $(document).keydown(function (t) {
            return function (e) {
                return (e.ctrlKey || e.metaKey) && (83 === e.which ? t.save(e) : 66 === e.which ? t.bold(e) : 73 === e.which ? t.italic(e) : 76 === e.which && t.link(e)), 27 === e.which && t.element.hasClass("is-fullscreen") ? fullscreen(e) : void 0
            }
        }(this)), $(window).bind("beforeunload", function (e) {
            return function () {
                return e.canExit ? void 0 : e.options.labelClose
            }
        }(this)), this.markdownScroll.scroll(function (e) {
            return function () {
                return e.isMarkdownMoving === !1 && (e.scrolling = "markdown", e._syncScroll()), !0
            }
        }(this)), this.previewScroll.scroll(function (e) {
            return function () {
                return e.isPreviewMoving === !1 && (e.scrolling = "preview", e._syncScroll()), !0
            }
        }(this))
    }, t.prototype._syncScroll = _.throttle(function () {
        var e, t, r;
        return this.preview.is(":visible") && 0 !== this.markdownSections.length && 0 !== this.previewSections.length ? (t = this.markdownScroll.scrollTop(), r = this.previewScroll.scrollTop(), e = 0, "markdown" === this.scrolling ? Math.abs(t - this.lastMarkdownScrollTop) <= 9 ? !1 : (this.scrolling = !1, this.lastMarkdownScrollTop = t, e = this._scrollTop(t, this.markdownSections, this.previewSections), Math.abs(e - r) <= 9 ? (this.lastPreviewScrollTop = r, !1) : (this.isPreviewMoving = !0, this.previewScroll.stop().animate({scrollTop: e}, 100, function (e) {
            return function () {
                return e.isPreviewMoving = !1, !0
            }
        }(this)))) : void 0) : !1
    }, 100), t.prototype._scrollTop = function (e, t, r) {
        var n, i, o, l;
        return l = 0, o = _.find(t, function (t, r) {
            return l = r, e < t.endOffset
        }), void 0 === o ? 0 : (i = (e - o.startOffset) / (o.height || 1), n = r[l], n.startOffset + n.height * i)
    }, t.prototype._buildToolbar = function () {
        return $('<button class="mdeditor_bold">b</button>').appendTo(this.toolbar).click(this.bold), $('<button class="mdeditor_italic">i</button>').appendTo(this.toolbar).click(this.italic), $('<button class="mdeditor_link">l</button>').appendTo(this.toolbar).click(this.link), $('<button class="mdeditor_code">c</button>').appendTo(this.toolbar).click(this.code), $('<button class="mdeditor_fullscreen">f</button>').appendTo(this.toolbar).click(this.fullscreen)
    }, t.prototype._buildDropzone = function () {
        var e, t, r;
        r = this.options, t = this.flash, e = this.editor, this.dropzone = new Dropzone($(".mdeditor_drop").get(0), {
            maxFiles: 10,
            paramName: "image",
            url: r.uploader,
            addRemoveLinks: !0,
            thumbnailWidth: 150,
            thumbnailHeight: 150,
            dictRemoveFile: r.labelDelete,
            init: function () {
                var n, i;
                return i = this, n = function (t) {
                    var n;
                    return n = $(t.previewElement), n.append('<a class="dz-insert" href="#">' + r.labelInsert + "</a>"), $(".dz-insert", n).click(function (r) {
                        var n;
                        return r.preventDefault(), r.stopPropagation(), e.doc.replaceSelection("![](" + t.url + ")"), n = e.doc.getCursor(), e.doc.setCursor({
                            line: n.line,
                            ch: 2
                        }), e.focus(), $(".mdeditor_modal").hide()
                    })
                }, this.on("addedfile", function (e) {
                    return n(e)
                }), this.on("sending", function (e, t, n) {
                    return $.extend(n, r.uploaderData)
                }), this.on("success", function (e, t) {
                    return $.extend(e, t), $(e.previewElement).removeClass("dz-processing")
                }), this.on("error", function (e, r) {
                    return t(r), $(e.previewElement).fadeOut()
                }), this.on("removedfile", function (e) {
                    return $.ajax({url: r.uploader + "/" + e.id, method: "DELETE"}).done(function () {
                    }).fail(function (e) {
                        return t(e.responseText)
                    })
                }), $.each(r.images, function (e, t) {
                    return i.options.addedfile.call(i, t), i.options.thumbnail.call(i, t, t.url), i.files.push(t), n(t)
                })
            }
        })
    }, t.prototype._setSections = _.debounce(function () {
        var e, t;
        this.markdownSections = [], this.previewSections = [], e = null, t = null, $(".CodeMirror-code .cm-header", this.element).each(function (t) {
            return function (r, n) {
                var i;
                return null === e ? (e = 0, void 0) : (i = $(n).offset().top + t.markdownScroll.scrollTop(), t.markdownSections.push({
                    startOffset: e,
                    endOffset: i,
                    height: i - e
                }), e = i, void 0)
            }
        }(this)), this.markdownSections.push({
            startOffset: e,
            endOffset: this.markdownScroll[0].scrollHeight,
            height: this.markdownScroll[0].scrollHeight - e
        }), this.preview.find("h1, h2, h3, h4, h5").each(function (e) {
            return function (r, n) {
                var i;
                return null === t ? (t = 0, void 0) : (i = $(n).offset().top + e.previewScroll.scrollTop(), e.previewSections.push({
                    startOffset: t,
                    endOffset: i,
                    height: i - t
                }), t = i, void 0)
            }
        }(this)), this.previewSections.push({
            startOffset: t,
            endOffset: this.previewScroll[0].scrollHeight,
            height: this.previewScroll[0].scrollHeight - t
        }), this.lastMardownScrollTop = -10, this.lastPreviewScrollTop = -10
    }, 500), t
}();
